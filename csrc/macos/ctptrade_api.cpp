...
// 用户登录请求
DLL_EXPORT_C_DECL int WPCTP tReqUserLogin(CThostFtdcTraderApi *api, CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID, TThostFtdcSystemInfoLenType length, TThostFtdcClientSystemInfoType systemInfo){ return api->ReqUserLogin(pReqUserLoginField, nRequestID, length, systemInfo); }
