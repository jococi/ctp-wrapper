...
var mpTThostFtdcExchangePropertyType = map[TThostFtdcExchangePropertyType]string{
	THOST_FTDC_EXP_Normal:          "正常",
	THOST_FTDC_EXP_GenOrderByTrade: "根据成交生成报单",
}
...
var mpTThostFtdcIdCardTypeType = map[TThostFtdcIdCardTypeType]string{
	THOST_FTDC_ICT_EID:                     "组织机构代码",
	THOST_FTDC_ICT_IDCard:                  "中国公民身份证",
	THOST_FTDC_ICT_OfficerIDCard:           "军官证",
	THOST_FTDC_ICT_PoliceIDCard:            "警官证",
	THOST_FTDC_ICT_SoldierIDCard:           "士兵证",
	THOST_FTDC_ICT_HouseholdRegister:       "户口簿",
	THOST_FTDC_ICT_Passport:                "护照",
	THOST_FTDC_ICT_TaiwanCompatriotIDCard:  "台胞证",
	THOST_FTDC_ICT_HomeComingCard:          "回乡证",
	THOST_FTDC_ICT_LicenseNo:               "营业执照号",
	THOST_FTDC_ICT_TaxNo:                   "税务登记号/当地纳税ID",
	THOST_FTDC_ICT_HMMainlandTravelPermit:  "港澳居民来往内地通行证",
	THOST_FTDC_ICT_TwMainlandTravelPermit:  "台湾居民来往大陆通行证",
	THOST_FTDC_ICT_DrivingLicense:          "驾照",
	THOST_FTDC_ICT_SocialID:                "当地社保ID",
	THOST_FTDC_ICT_LocalID:                 "当地身份证",
	THOST_FTDC_ICT_BusinessRegistration:    "商业登记证",
	THOST_FTDC_ICT_HKMCIDCard:              "港澳永久性居民身份证",
	THOST_FTDC_ICT_AccountsPermits:         "人行开户许可证",
	THOST_FTDC_ICT_FrgPrmtRdCard:           "外国人永久居留证",
	THOST_FTDC_ICT_CptMngPrdLetter:         "资管产品备案函",
	THOST_FTDC_ICT_HKMCTwResidencePermit:   "港澳台居民居住证",
	THOST_FTDC_ICT_UniformSocialCreditCode: "统一社会信用代码",
	THOST_FTDC_ICT_CorporationCertNo:       "机构成立证明文件",
	THOST_FTDC_ICT_OtherCard:               "其他证件",
}
...
var mpTThostFtdcInvestorRangeType = map[TThostFtdcInvestorRangeType]string{
	THOST_FTDC_IR_All:    "所有",
	THOST_FTDC_IR_Group:  "投资者组",
	THOST_FTDC_IR_Single: "单一投资者",
}
...
var mpTThostFtdcDepartmentRangeType = map[TThostFtdcDepartmentRangeType]string{
	THOST_FTDC_DR_All:    "所有",
	THOST_FTDC_DR_Group:  "组织架构",
	THOST_FTDC_DR_Single: "单一投资者",
}
...
var mpTThostFtdcDataSyncStatusType = map[TThostFtdcDataSyncStatusType]string{
	THOST_FTDC_DS_Asynchronous:  "未同步",
	THOST_FTDC_DS_Synchronizing: "同步中",
	THOST_FTDC_DS_Synchronized:  "已同步",
}
...
var mpTThostFtdcBrokerDataSyncStatusType = map[TThostFtdcBrokerDataSyncStatusType]string{
	THOST_FTDC_BDS_Synchronized:  "已同步",
	THOST_FTDC_BDS_Synchronizing: "同步中",
}
...
var mpTThostFtdcExchangeConnectStatusType = map[TThostFtdcExchangeConnectStatusType]string{
	THOST_FTDC_ECS_NoConnection:      "没有任何连接",
	THOST_FTDC_ECS_QryInstrumentSent: "已经发出合约查询请求",
	THOST_FTDC_ECS_GotInformation:    "已经获取信息",
}
...
var mpTThostFtdcTraderConnectStatusType = map[TThostFtdcTraderConnectStatusType]string{
	THOST_FTDC_TCS_NotConnected:      "没有任何连接",
	THOST_FTDC_TCS_Connected:         "已经连接",
	THOST_FTDC_TCS_QryInstrumentSent: "已经发出合约查询请求",
	THOST_FTDC_TCS_SubPrivateFlow:    "订阅私有流",
}
...
var mpTThostFtdcFunctionCodeType = map[TThostFtdcFunctionCodeType]string{
	THOST_FTDC_FC_DataAsync:              "数据异步化",
	THOST_FTDC_FC_ForceUserLogout:        "强制用户登出",
	THOST_FTDC_FC_UserPasswordUpdate:     "变更管理用户口令",
	THOST_FTDC_FC_BrokerPasswordUpdate:   "变更经纪公司口令",
	THOST_FTDC_FC_InvestorPasswordUpdate: "变更投资者口令",
	THOST_FTDC_FC_OrderInsert:            "报单插入",
	THOST_FTDC_FC_OrderAction:            "报单操作",
	THOST_FTDC_FC_SyncSystemData:         "同步系统数据",
	THOST_FTDC_FC_SyncBrokerData:         "同步经纪公司数据",
	THOST_FTDC_FC_BachSyncBrokerData:     "批量同步经纪公司数据",
	THOST_FTDC_FC_SuperQuery:             "超级查询",
	THOST_FTDC_FC_ParkedOrderInsert:      "预埋报单插入",
	THOST_FTDC_FC_ParkedOrderAction:      "预埋报单操作",
	THOST_FTDC_FC_SyncOTP:                "同步动态令牌",
	THOST_FTDC_FC_DeleteOrder:            "删除未知单",
}
...
var mpTThostFtdcBrokerFunctionCodeType = map[TThostFtdcBrokerFunctionCodeType]string{
	THOST_FTDC_BFC_ForceUserLogout:    "强制用户登出",
	THOST_FTDC_BFC_UserPasswordUpdate: "变更用户口令",
	THOST_FTDC_BFC_SyncBrokerData:     "同步经纪公司数据",
	THOST_FTDC_BFC_BachSyncBrokerData: "批量同步经纪公司数据",
	THOST_FTDC_BFC_OrderInsert:        "报单插入",
	THOST_FTDC_BFC_OrderAction:        "报单操作",
	THOST_FTDC_BFC_AllQuery:           "全部查询",
	THOST_FTDC_BFC_log:                "系统功能：登入/登出/修改密码等",
	THOST_FTDC_BFC_BaseQry:            "基本查询：查询基础数据，如合约，交易所等常量",
	THOST_FTDC_BFC_TradeQry:           "交易查询：如查成交，委托",
	THOST_FTDC_BFC_Trade:              "交易功能：报单，撤单",
	THOST_FTDC_BFC_Virement:           "银期转账",
	THOST_FTDC_BFC_Risk:               "风险监控",
	THOST_FTDC_BFC_Session:            "查询/管理：查询会话，踢人等",
	THOST_FTDC_BFC_RiskNoticeCtl:      "风控通知控制",
	THOST_FTDC_BFC_RiskNotice:         "风控通知发送",
	THOST_FTDC_BFC_BrokerDeposit:      "察看经纪公司资金权限",
	THOST_FTDC_BFC_QueryFund:          "资金查询",
	THOST_FTDC_BFC_QueryOrder:         "报单查询",
	THOST_FTDC_BFC_QueryTrade:         "成交查询",
	THOST_FTDC_BFC_QueryPosition:      "持仓查询",
	THOST_FTDC_BFC_QueryMarketData:    "行情查询",
	THOST_FTDC_BFC_QueryUserEvent:     "用户事件查询",
	THOST_FTDC_BFC_QueryRiskNotify:    "风险通知查询",
	THOST_FTDC_BFC_QueryFundChange:    "出入金查询",
	THOST_FTDC_BFC_QueryInvestor:      "投资者信息查询",
	THOST_FTDC_BFC_QueryTradingCode:   "交易编码查询",
	THOST_FTDC_BFC_ForceClose:         "强平",
	THOST_FTDC_BFC_PressTest:          "压力测试",
	THOST_FTDC_BFC_RemainCalc:         "权益反算",
	THOST_FTDC_BFC_NetPositionInd:     "净持仓保证金指标",
	THOST_FTDC_BFC_RiskPredict:        "风险预算",
	THOST_FTDC_BFC_DataExport:         "数据导出",
	THOST_FTDC_BFC_RiskTargetSetup:    "风控指标设置",
	THOST_FTDC_BFC_MarketDataWarn:     "行情预警",
	THOST_FTDC_BFC_QryBizNotice:       "业务通知查询",
	THOST_FTDC_BFC_CfgBizNotice:       "业务通知模板设置",
	THOST_FTDC_BFC_SyncOTP:            "同步动态令牌",
	THOST_FTDC_BFC_SendBizNotice:      "发送业务通知",
	THOST_FTDC_BFC_CfgRiskLevelStd:    "风险级别标准设置",
	THOST_FTDC_BFC_TbCommand:          "交易终端应急功能",
	THOST_FTDC_BFC_DeleteOrder:        "删除未知单",
	THOST_FTDC_BFC_ParkedOrderInsert:  "预埋报单插入",
	THOST_FTDC_BFC_ParkedOrderAction:  "预埋报单操作",
	THOST_FTDC_BFC_ExecOrderNoCheck:   "资金不够仍允许行权",
	THOST_FTDC_BFC_Designate:          "指定",
	THOST_FTDC_BFC_StockDisposal:      "证券处置",
	THOST_FTDC_BFC_BrokerDepositWarn:  "席位资金预警",
	THOST_FTDC_BFC_CoverWarn:          "备兑不足预警",
	THOST_FTDC_BFC_PreExecOrder:       "行权试算",
	THOST_FTDC_BFC_ExecOrderRisk:      "行权交收风险",
	THOST_FTDC_BFC_PosiLimitWarn:      "持仓限额预警",
	THOST_FTDC_BFC_QryPosiLimit:       "持仓限额查询",
	THOST_FTDC_BFC_FBSign:             "银期签到签退",
	THOST_FTDC_BFC_FBAccount:          "银期签约解约",
}
...
var mpTThostFtdcOrderActionStatusType = map[TThostFtdcOrderActionStatusType]string{
	THOST_FTDC_OAS_Submitted: "已经提交",
	THOST_FTDC_OAS_Accepted:  "已经接受",
	THOST_FTDC_OAS_Rejected:  "已经被拒绝",
}
...
var mpTThostFtdcOrderStatusType = map[TThostFtdcOrderStatusType]string{
...
var mpTThostFtdcOrderSubmitStatusType = map[TThostFtdcOrderSubmitStatusType]string{
	THOST_FTDC_OSS_InsertSubmitted: "已经提交",
	THOST_FTDC_OSS_CancelSubmitted: "撤单已经提交",
	THOST_FTDC_OSS_ModifySubmitted: "修改已经提交",
	THOST_FTDC_OSS_Accepted:        "已经接受",
	THOST_FTDC_OSS_InsertRejected:  "报单已经被拒绝",
	THOST_FTDC_OSS_CancelRejected:  "撤单已经被拒绝",
	THOST_FTDC_OSS_ModifyRejected:  "改单已经被拒绝",
}
...
var mpTThostFtdcPositionDateType = map[TThostFtdcPositionDateType]string{
	THOST_FTDC_PSD_Today:   "今日持仓",
	THOST_FTDC_PSD_History: "历史持仓",
}
...
var mpTThostFtdcPositionDateTypeType = map[TThostFtdcPositionDateTypeType]string{
	THOST_FTDC_PDT_UseHistory:   "使用历史持仓",
	THOST_FTDC_PDT_NoUseHistory: "不使用历史持仓",
}
...
var mpTThostFtdcTradingRoleType = map[TThostFtdcTradingRoleType]string{
	THOST_FTDC_ER_Broker: "代理",
	THOST_FTDC_ER_Host:   "自营",
	THOST_FTDC_ER_Maker:  "做市商",
}
...
var mpTThostFtdcProductClassType = map[TThostFtdcProductClassType]string{
	THOST_FTDC_PC_Futures:     "期货",
	THOST_FTDC_PC_Options:     "期货期权",
	THOST_FTDC_PC_Combination: "组合",
	THOST_FTDC_PC_Spot:        "即期",
	THOST_FTDC_PC_EFP:         "期转现",
	THOST_FTDC_PC_SpotOption:  "现货期权",
	THOST_FTDC_PC_TAS:         "TAS合约",
	THOST_FTDC_PC_MI:          "金属指数",
}
...
var mpTThostFtdcAPIProductClassType = map[TThostFtdcAPIProductClassType]string{
	THOST_FTDC_APC_FutureSingle:  "期货单一合约",
	THOST_FTDC_APC_OptionSingle:  "期权单一合约",
	THOST_FTDC_APC_Futures:       "可交易期货(含期货组合和期货单一合约)",
	THOST_FTDC_APC_Options:       "可交易期权(含期权组合和期权单一合约)",
	THOST_FTDC_APC_TradingComb:   "可下单套利组合",
	THOST_FTDC_APC_UnTradingComb: "可申请的组合（可以申请的组合合约 包含可以交易的合约）",
	THOST_FTDC_APC_AllTrading:    "所有可以交易合约",
	THOST_FTDC_APC_All:           "所有合约（包含不能交易合约 慎用）",
}
...
var mpTThostFtdcInstLifePhaseType = map[TThostFtdcInstLifePhaseType]string{
	THOST_FTDC_IP_NotStart: "未上市",
	THOST_FTDC_IP_Started:  "上市",
	THOST_FTDC_IP_Pause:    "停牌",
	THOST_FTDC_IP_Expired:  "到期",
}
...
var mpTThostFtdcDirectionType = map[TThostFtdcDirectionType]string{
	THOST_FTDC_D_Buy:  "买",
	THOST_FTDC_D_Sell: "卖",
}
...
var mpTThostFtdcPositionTypeType = map[TThostFtdcPositionTypeType]string{
	THOST_FTDC_PT_Net:   "净持仓",
	THOST_FTDC_PT_Gross: "综合持仓",
}
...
var mpTThostFtdcPosiDirectionType = map[TThostFtdcPosiDirectionType]string{
	THOST_FTDC_PD_Net:   "净",
...
var mpTThostFtdcSysSettlementStatusType = map[TThostFtdcSysSettlementStatusType]string{
	THOST_FTDC_SS_NonActive:          "不活跃",
	THOST_FTDC_SS_Startup:            "启动",
	THOST_FTDC_SS_Operating:          "操作",
	THOST_FTDC_SS_Settlement:         "结算",
	THOST_FTDC_SS_SettlementFinished: "结算完成",
}
...
var mpTThostFtdcRatioAttrType = map[TThostFtdcRatioAttrType]string{
	THOST_FTDC_RA_Trade:      "交易费率",
	THOST_FTDC_RA_Settlement: "结算费率",
}
...
var mpTThostFtdcHedgeFlagType = map[TThostFtdcHedgeFlagType]string{
...
var mpTThostFtdcBillHedgeFlagType = map[TThostFtdcBillHedgeFlagType]string{
	THOST_FTDC_BHF_Speculation: "投机",
	THOST_FTDC_BHF_Arbitrage:   "套利",
	THOST_FTDC_BHF_Hedge:       "套保",
}
...
var mpTThostFtdcClientIDTypeType = map[TThostFtdcClientIDTypeType]string{
	THOST_FTDC_CIDT_Speculation: "投机",
	THOST_FTDC_CIDT_Arbitrage:   "套利",
	THOST_FTDC_CIDT_Hedge:       "套保",
	THOST_FTDC_CIDT_MarketMaker: "做市商",
}
...
var mpTThostFtdcOrderPriceTypeType = map[TThostFtdcOrderPriceTypeType]string{
...
var mpTThostFtdcOffsetFlagType = map[TThostFtdcOffsetFlagType]string{
...
var mpTThostFtdcForceCloseReasonType = map[TThostFtdcForceCloseReasonType]string{
...
var mpTThostFtdcOrderTypeType = map[TThostFtdcOrderTypeType]string{
	THOST_FTDC_ORDT_Normal:                "正常",
	THOST_FTDC_ORDT_DeriveFromQuote:       "报价衍生",
	THOST_FTDC_ORDT_DeriveFromCombination: "组合衍生",
	THOST_FTDC_ORDT_Combination:           "组合报单",
	THOST_FTDC_ORDT_ConditionalOrder:      "条件单",
	THOST_FTDC_ORDT_Swap:                  "互换单",
	THOST_FTDC_ORDT_DeriveFromBlockTrade:  "大宗交易成交衍生",
	THOST_FTDC_ORDT_DeriveFromEFPTrade:    "期转现成交衍生",
}
...
var mpTThostFtdcTimeConditionType = map[TThostFtdcTimeConditionType]string{
...
var mpTThostFtdcVolumeConditionType = map[TThostFtdcVolumeConditionType]string{
...
var mpTThostFtdcContingentConditionType = map[TThostFtdcContingentConditionType]string{
...
var mpTThostFtdcActionFlagType = map[TThostFtdcActionFlagType]string{
	THOST_FTDC_AF_Delete: "删除",
	THOST_FTDC_AF_Modify: "修改",
}
...
var mpTThostFtdcTradingRightType = map[TThostFtdcTradingRightType]string{
	THOST_FTDC_TR_Allow:     "可以交易",
	THOST_FTDC_TR_CloseOnly: "只能平仓",
	THOST_FTDC_TR_Forbidden: "不能交易",
}
...
var mpTThostFtdcOrderSourceType = map[TThostFtdcOrderSourceType]string{
	THOST_FTDC_OSRC_Participant:   "来自参与者",
	THOST_FTDC_OSRC_Administrator: "来自管理员",
}
...
var mpTThostFtdcTradeTypeType = map[TThostFtdcTradeTypeType]string{
	THOST_FTDC_TRDT_SplitCombination:   "组合持仓拆分为单一持仓,初始化不应包含该类型的持仓",
	THOST_FTDC_TRDT_Common:             "普通成交",
	THOST_FTDC_TRDT_OptionsExecution:   "期权执行",
	THOST_FTDC_TRDT_OTC:                "OTC成交",
	THOST_FTDC_TRDT_EFPDerived:         "期转现衍生成交",
	THOST_FTDC_TRDT_CombinationDerived: "组合衍生成交",
	THOST_FTDC_TRDT_BlockTrade:         "大宗交易成交",
}
...
var mpTThostFtdcSpecPosiTypeType = map[TThostFtdcSpecPosiTypeType]string{
	THOST_FTDC_SPOST_Common: "普通持仓明细",
	THOST_FTDC_SPOST_Tas:    "TAS合约成交产生的标的合约持仓明细",
}
...
var mpTThostFtdcPriceSourceType = map[TThostFtdcPriceSourceType]string{
	THOST_FTDC_PSRC_LastPrice: "前成交价",
	THOST_FTDC_PSRC_Buy:       "买委托价",
	THOST_FTDC_PSRC_Sell:      "卖委托价",
	THOST_FTDC_PSRC_OTC:       "场外成交价",
}
...
var mpTThostFtdcInstrumentStatusType = map[TThostFtdcInstrumentStatusType]string{
	THOST_FTDC_IS_BeforeTrading:   "开盘前",
	THOST_FTDC_IS_NoTrading:       "非交易",
	THOST_FTDC_IS_Continous:       "连续交易",
	THOST_FTDC_IS_AuctionOrdering: "集合竞价报单",
	THOST_FTDC_IS_AuctionBalance:  "集合竞价价格平衡",
	THOST_FTDC_IS_AuctionMatch:    "集合竞价撮合",
	THOST_FTDC_IS_Closed:          "收盘",
}
...
var mpTThostFtdcInstStatusEnterReasonType = map[TThostFtdcInstStatusEnterReasonType]string{
	THOST_FTDC_IER_Automatic: "自动切换",
	THOST_FTDC_IER_Manual:    "手动切换",
	THOST_FTDC_IER_Fuse:      "熔断",
}
...
var mpTThostFtdcBatchStatusType = map[TThostFtdcBatchStatusType]string{
	THOST_FTDC_BS_NoUpload: "未上传",
	THOST_FTDC_BS_Uploaded: "已上传",
	THOST_FTDC_BS_Failed:   "审核失败",
}
...
var mpTThostFtdcReturnStyleType = map[TThostFtdcReturnStyleType]string{
	THOST_FTDC_RS_All:       "按所有品种",
	THOST_FTDC_RS_ByProduct: "按品种",
}
...
var mpTThostFtdcReturnPatternType = map[TThostFtdcReturnPatternType]string{
	THOST_FTDC_RP_ByVolume:    "按成交手数",
	THOST_FTDC_RP_ByFeeOnHand: "按留存手续费",
}
...
var mpTThostFtdcReturnLevelType = map[TThostFtdcReturnLevelType]string{
	THOST_FTDC_RL_Level1: "级别1",
	THOST_FTDC_RL_Level2: "级别2",
	THOST_FTDC_RL_Level3: "级别3",
	THOST_FTDC_RL_Level4: "级别4",
	THOST_FTDC_RL_Level5: "级别5",
	THOST_FTDC_RL_Level6: "级别6",
	THOST_FTDC_RL_Level7: "级别7",
	THOST_FTDC_RL_Level8: "级别8",
	THOST_FTDC_RL_Level9: "级别9",
}
...
var mpTThostFtdcReturnStandardType = map[TThostFtdcReturnStandardType]string{
	THOST_FTDC_RSD_ByPeriod:   "分阶段返还",
	THOST_FTDC_RSD_ByStandard: "按某一标准",
}
...
var mpTThostFtdcMortgageTypeType = map[TThostFtdcMortgageTypeType]string{
	THOST_FTDC_MT_Out: "质出",
	THOST_FTDC_MT_In:  "质入",
}
...
var mpTThostFtdcInvestorSettlementParamIDType = map[TThostFtdcInvestorSettlementParamIDType]string{
	THOST_FTDC_ISPI_MortgageRatio: "质押比例",
	THOST_FTDC_ISPI_MarginWay:     "保证金算法",
	THOST_FTDC_ISPI_BillDeposit:   "结算单结存是否包含质押",
}
...
var mpTThostFtdcExchangeSettlementParamIDType = map[TThostFtdcExchangeSettlementParamIDType]string{
	THOST_FTDC_ESPI_MortgageRatio:      "质押比例",
	THOST_FTDC_ESPI_OtherFundItem:      "分项资金导入项",
	THOST_FTDC_ESPI_OtherFundImport:    "分项资金入交易所出入金",
	THOST_FTDC_ESPI_CFFEXMinPrepa:      "中金所开户最低可用金额",
	THOST_FTDC_ESPI_CZCESettlementType: "郑商所结算方式",
	THOST_FTDC_ESPI_ExchDelivFeeMode:   "交易所交割手续费收取方式",
	THOST_FTDC_ESPI_DelivFeeMode:       "投资者交割手续费收取方式",
	THOST_FTDC_ESPI_CZCEComMarginType:  "郑商所组合持仓保证金收取方式",
	THOST_FTDC_ESPI_DceComMarginType:   "大商所套利保证金是否优惠",
	THOST_FTDC_ESPI_OptOutDisCountRate: "虚值期权保证金优惠比率",
	THOST_FTDC_ESPI_OptMiniGuarantee:   "最低保障系数",
}
...
var mpTThostFtdcSystemParamIDType = map[TThostFtdcSystemParamIDType]string{
	THOST_FTDC_SPI_InvestorIDMinLength:     "投资者代码最小长度",
	THOST_FTDC_SPI_AccountIDMinLength:      "投资者帐号代码最小长度",
	THOST_FTDC_SPI_UserRightLogon:          "投资者开户默认登录权限",
	THOST_FTDC_SPI_SettlementBillTrade:     "投资者交易结算单成交汇总方式",
	THOST_FTDC_SPI_TradingCode:             "统一开户更新交易编码方式",
	THOST_FTDC_SPI_CheckFund:               "结算是否判断存在未复核的出入金和分项资金",
	THOST_FTDC_SPI_CommModelRight:          "是否启用手续费模板数据权限",
	THOST_FTDC_SPI_MarginModelRight:        "是否启用保证金率模板数据权限",
	THOST_FTDC_SPI_IsStandardActive:        "是否规范用户才能激活",
	THOST_FTDC_SPI_UploadSettlementFile:    "上传的交易所结算文件路径",
	THOST_FTDC_SPI_DownloadCSRCFile:        "上报保证金监控中心文件路径",
	THOST_FTDC_SPI_SettlementBillFile:      "生成的结算单文件路径",
	THOST_FTDC_SPI_CSRCOthersFile:          "证监会文件标识",
	THOST_FTDC_SPI_InvestorPhoto:           "投资者照片路径",
	THOST_FTDC_SPI_CSRCData:                "全结经纪公司上传文件路径",
	THOST_FTDC_SPI_InvestorPwdModel:        "开户密码录入方式",
	THOST_FTDC_SPI_CFFEXInvestorSettleFile: "投资者中金所结算文件下载路径",
	THOST_FTDC_SPI_InvestorIDType:          "投资者代码编码方式",
	THOST_FTDC_SPI_FreezeMaxReMain:         "休眠户最高权益",
	THOST_FTDC_SPI_IsSync:                  "手续费相关操作实时上场开关",
	THOST_FTDC_SPI_RelieveOpenLimit:        "解除开仓权限限制",
	THOST_FTDC_SPI_IsStandardFreeze:        "是否规范用户才能休眠",
	THOST_FTDC_SPI_CZCENormalProductHedge:  "郑商所是否开放所有品种套保交易",
}
...
var mpTThostFtdcTradeParamIDType = map[TThostFtdcTradeParamIDType]string{
	THOST_FTDC_TPID_EncryptionStandard:      "系统加密算法",
	THOST_FTDC_TPID_RiskMode:                "系统风险算法",
	THOST_FTDC_TPID_RiskModeGlobal:          "系统风险算法是否全局 0-否 1-是",
	THOST_FTDC_TPID_modeEncode:              "密码加密算法",
	THOST_FTDC_TPID_tickMode:                "价格小数位数参数",
	THOST_FTDC_TPID_SingleUserSessionMaxNum: "用户最大会话数",
	THOST_FTDC_TPID_LoginFailMaxNum:         "最大连续登录失败数",
	THOST_FTDC_TPID_IsAuthForce:             "是否强制认证",
	THOST_FTDC_TPID_IsPosiFreeze:            "是否冻结证券持仓",
	THOST_FTDC_TPID_IsPosiLimit:             "是否限仓",
	THOST_FTDC_TPID_ForQuoteTimeInterval:    "郑商所询价时间间隔",
	THOST_FTDC_TPID_IsFuturePosiLimit:       "是否期货限仓",
	THOST_FTDC_TPID_IsFutureOrderFreq:       "是否期货下单频率限制",
	THOST_FTDC_TPID_IsExecOrderProfit:       "行权冻结是否计算盈利",
	THOST_FTDC_TPID_IsCheckBankAcc:          "银期开户是否验证开户银行卡号是否是预留银行账户",
	THOST_FTDC_TPID_PasswordDeadLine:        "弱密码最后修改日期",
	THOST_FTDC_TPID_IsStrongPassword:        "强密码校验",
	THOST_FTDC_TPID_BalanceMorgage:          "自有资金质押比",
	THOST_FTDC_TPID_MinPwdLen:               "最小密码长度",
	THOST_FTDC_TPID_LoginFailMaxNumForIP:    "IP当日最大登陆失败次数",
	THOST_FTDC_TPID_PasswordPeriod:          "密码有效期",
}
...
var mpTThostFtdcFileIDType = map[TThostFtdcFileIDType]string{
	THOST_FTDC_FI_SettlementFund:            "资金数据",
	THOST_FTDC_FI_Trade:                     "成交数据",
	THOST_FTDC_FI_InvestorPosition:          "投资者持仓数据",
	THOST_FTDC_FI_SubEntryFund:              "投资者分项资金数据",
	THOST_FTDC_FI_CZCECombinationPos:        "组合持仓数据",
	THOST_FTDC_FI_CSRCData:                  "上报保证金监控中心数据",
	THOST_FTDC_FI_CZCEClose:                 "郑商所平仓了结数据",
	THOST_FTDC_FI_CZCENoClose:               "郑商所非平仓了结数据",
	THOST_FTDC_FI_PositionDtl:               "持仓明细数据",
	THOST_FTDC_FI_OptionStrike:              "期权执行文件",
	THOST_FTDC_FI_SettlementPriceComparison: "结算价比对文件",
	THOST_FTDC_FI_NonTradePosChange:         "上期所非持仓变动明细",
}
...
var mpTThostFtdcFileTypeType = map[TThostFtdcFileTypeType]string{
	THOST_FTDC_FUT_Settlement: "结算",
	THOST_FTDC_FUT_Check:      "核对",
}
...
var mpTThostFtdcFileFormatType = map[TThostFtdcFileFormatType]string{
	THOST_FTDC_FFT_Txt: "文本文件(.txt)",
	THOST_FTDC_FFT_Zip: "压缩文件(.zip)",
	THOST_FTDC_FFT_DBF: "DBF文件(.dbf)",
}
...
var mpTThostFtdcFileUploadStatusType = map[TThostFtdcFileUploadStatusType]string{
	THOST_FTDC_FUS_SucceedUpload:   "上传成功",
	THOST_FTDC_FUS_FailedUpload:    "上传失败",
	THOST_FTDC_FUS_SucceedLoad:     "导入成功",
	THOST_FTDC_FUS_PartSucceedLoad: "导入部分成功",
	THOST_FTDC_FUS_FailedLoad:      "导入失败",
}
...
var mpTThostFtdcTransferDirectionType = map[TThostFtdcTransferDirectionType]string{
	THOST_FTDC_TD_Out: "移出",
	THOST_FTDC_TD_In:  "移入",
}
...
var mpTThostFtdcSpecialCreateRuleType = map[TThostFtdcSpecialCreateRuleType]string{
	THOST_FTDC_SC_NoSpecialRule:    "没有特殊创建规则",
	THOST_FTDC_SC_NoSpringFestival: "不包含春节",
}
...
var mpTThostFtdcBasisPriceTypeType = map[TThostFtdcBasisPriceTypeType]string{
	THOST_FTDC_IPT_LastSettlement: "上一合约结算价",
	THOST_FTDC_IPT_LaseClose:      "上一合约收盘价",
}
...
var mpTThostFtdcProductLifePhaseType = map[TThostFtdcProductLifePhaseType]string{
	THOST_FTDC_PLP_Active:    "活跃",
	THOST_FTDC_PLP_NonActive: "不活跃",
	THOST_FTDC_PLP_Canceled:  "注销",
}
...
var mpTThostFtdcDeliveryModeType = map[TThostFtdcDeliveryModeType]string{
	THOST_FTDC_DM_CashDeliv:      "现金交割",
	THOST_FTDC_DM_CommodityDeliv: "实物交割",
}
...
var mpTThostFtdcFundIOTypeType = map[TThostFtdcFundIOTypeType]string{
	THOST_FTDC_FIOT_FundIO:       "出入金",
	THOST_FTDC_FIOT_Transfer:     "银期转帐",
	THOST_FTDC_FIOT_SwapCurrency: "银期换汇",
}
...
var mpTThostFtdcFundTypeType = map[TThostFtdcFundTypeType]string{
	THOST_FTDC_FT_Deposite:      "银行存款",
	THOST_FTDC_FT_ItemFund:      "分项资金",
	THOST_FTDC_FT_Company:       "公司调整",
	THOST_FTDC_FT_InnerTransfer: "资金内转",
}
...
var mpTThostFtdcFundDirectionType = map[TThostFtdcFundDirectionType]string{
	THOST_FTDC_FD_In:  "入金",
	THOST_FTDC_FD_Out: "出金",
}
...
var mpTThostFtdcFundStatusType = map[TThostFtdcFundStatusType]string{
	THOST_FTDC_FS_Record: "已录入",
	THOST_FTDC_FS_Check:  "已复核",
	THOST_FTDC_FS_Charge: "已冲销",
}
...
var mpTThostFtdcPublishStatusType = map[TThostFtdcPublishStatusType]string{
	THOST_FTDC_PS_None:       "未发布",
	THOST_FTDC_PS_Publishing: "正在发布",
	THOST_FTDC_PS_Published:  "已发布",
}
...
var mpTThostFtdcSystemStatusType = map[TThostFtdcSystemStatusType]string{
	THOST_FTDC_ES_NonActive:   "不活跃",
	THOST_FTDC_ES_Startup:     "启动",
	THOST_FTDC_ES_Initialize:  "交易开始初始化",
	THOST_FTDC_ES_Initialized: "交易完成初始化",
	THOST_FTDC_ES_Close:       "收市开始",
	THOST_FTDC_ES_Closed:      "收市完成",
	THOST_FTDC_ES_Settlement:  "结算",
}
...
var mpTThostFtdcSettlementStatusType = map[TThostFtdcSettlementStatusType]string{
	THOST_FTDC_STS_Initialize:    "初始",
	THOST_FTDC_STS_Settlementing: "结算中",
	THOST_FTDC_STS_Settlemented:  "已结算",
	THOST_FTDC_STS_Finished:      "结算完成",
}
...
var mpTThostFtdcInvestorTypeType = map[TThostFtdcInvestorTypeType]string{
	THOST_FTDC_CT_Person:       "自然人",
	THOST_FTDC_CT_Company:      "法人",
	THOST_FTDC_CT_Fund:         "投资基金",
	THOST_FTDC_CT_SpecialOrgan: "特殊法人",
	THOST_FTDC_CT_Asset:        "资管户",
}
...
var mpTThostFtdcBrokerTypeType = map[TThostFtdcBrokerTypeType]string{
	THOST_FTDC_BT_Trade:       "交易会员",
	THOST_FTDC_BT_TradeSettle: "交易结算会员",
}
...
var mpTThostFtdcRiskLevelType = map[TThostFtdcRiskLevelType]string{
	THOST_FTDC_FAS_Low:    "低风险客户",
	THOST_FTDC_FAS_Normal: "普通客户",
	THOST_FTDC_FAS_Focus:  "关注客户",
	THOST_FTDC_FAS_Risk:   "风险客户",
}
...
var mpTThostFtdcFeeAcceptStyleType = map[TThostFtdcFeeAcceptStyleType]string{
	THOST_FTDC_FAS_ByTrade: "按交易收取",
	THOST_FTDC_FAS_ByDeliv: "按交割收取",
	THOST_FTDC_FAS_None:    "不收",
	THOST_FTDC_FAS_FixFee:  "按指定手续费收取",
}
...
var mpTThostFtdcPasswordTypeType = map[TThostFtdcPasswordTypeType]string{
	THOST_FTDC_PWDT_Trade:   "交易密码",
	THOST_FTDC_PWDT_Account: "资金密码",
}
...
var mpTThostFtdcAlgorithmType = map[TThostFtdcAlgorithmType]string{
	THOST_FTDC_AG_All:      "浮盈浮亏都计算",
	THOST_FTDC_AG_OnlyLost: "浮盈不计，浮亏计",
	THOST_FTDC_AG_OnlyGain: "浮盈计，浮亏不计",
	THOST_FTDC_AG_None:     "浮盈浮亏都不计算",
}
...
var mpTThostFtdcIncludeCloseProfitType = map[TThostFtdcIncludeCloseProfitType]string{
	THOST_FTDC_ICP_Include:    "包含平仓盈利",
	THOST_FTDC_ICP_NotInclude: "不包含平仓盈利",
}
...
var mpTThostFtdcAllWithoutTradeType = map[TThostFtdcAllWithoutTradeType]string{
	THOST_FTDC_AWT_Enable:       "无仓无成交不受可提比例限制",
	THOST_FTDC_AWT_Disable:      "受可提比例限制",
	THOST_FTDC_AWT_NoHoldEnable: "无仓不受可提比例限制",
}
...
var mpTThostFtdcFuturePwdFlagType = map[TThostFtdcFuturePwdFlagType]string{
	THOST_FTDC_FPWD_UnCheck: "不核对",
	THOST_FTDC_FPWD_Check:   "核对",
}
...
var mpTThostFtdcTransferTypeType = map[TThostFtdcTransferTypeType]string{
	THOST_FTDC_TT_BankToFuture: "银行转期货",
	THOST_FTDC_TT_FutureToBank: "期货转银行",
}
...
var mpTThostFtdcTransferValidFlagType = map[TThostFtdcTransferValidFlagType]string{
	THOST_FTDC_TVF_Invalid: "无效或失败",
	THOST_FTDC_TVF_Valid:   "有效",
	THOST_FTDC_TVF_Reverse: "冲正",
}
...
var mpTThostFtdcReasonType = map[TThostFtdcReasonType]string{
	THOST_FTDC_RN_CD: "错单",
	THOST_FTDC_RN_ZT: "资金在途",
	THOST_FTDC_RN_QT: "其它",
}
...
var mpTThostFtdcSexType = map[TThostFtdcSexType]string{
	THOST_FTDC_SEX_None:  "未知",
	THOST_FTDC_SEX_Man:   "男",
	THOST_FTDC_SEX_Woman: "女",
}
...
var mpTThostFtdcUserTypeType = map[TThostFtdcUserTypeType]string{
	THOST_FTDC_UT_Investor:  "投资者",
	THOST_FTDC_UT_Operator:  "操作员",
	THOST_FTDC_UT_SuperUser: "管理员",
}
...
var mpTThostFtdcRateTypeType = map[TThostFtdcRateTypeType]string{
	THOST_FTDC_RATETYPE_MarginRate: "保证金率",
}
...
var mpTThostFtdcNoteTypeType = map[TThostFtdcNoteTypeType]string{
	THOST_FTDC_NOTETYPE_TradeSettleBill:  "交易结算单",
	THOST_FTDC_NOTETYPE_TradeSettleMonth: "交易结算月报",
	THOST_FTDC_NOTETYPE_CallMarginNotes:  "追加保证金通知书",
	THOST_FTDC_NOTETYPE_ForceCloseNotes:  "强行平仓通知书",
	THOST_FTDC_NOTETYPE_TradeNotes:       "成交通知书",
	THOST_FTDC_NOTETYPE_DelivNotes:       "交割通知书",
}
...
var mpTThostFtdcSettlementStyleType = map[TThostFtdcSettlementStyleType]string{
	THOST_FTDC_SBS_Day:    "逐日盯市",
	THOST_FTDC_SBS_Volume: "逐笔对冲",
}
...
var mpTThostFtdcSettlementBillTypeType = map[TThostFtdcSettlementBillTypeType]string{
	THOST_FTDC_ST_Day:   "日报",
	THOST_FTDC_ST_Month: "月报",
}
...
var mpTThostFtdcUserRightTypeType = map[TThostFtdcUserRightTypeType]string{
	THOST_FTDC_URT_Logon:          "登录",
	THOST_FTDC_URT_Transfer:       "银期转帐",
	THOST_FTDC_URT_EMail:          "邮寄结算单",
	THOST_FTDC_URT_Fax:            "传真结算单",
	THOST_FTDC_URT_ConditionOrder: "条件单",
}
...
var mpTThostFtdcMarginPriceTypeType = map[TThostFtdcMarginPriceTypeType]string{
	THOST_FTDC_MPT_PreSettlementPrice: "昨结算价",
	THOST_FTDC_MPT_SettlementPrice:    "最新价",
	THOST_FTDC_MPT_AveragePrice:       "成交均价",
	THOST_FTDC_MPT_OpenPrice:          "开仓价",
}
...
var mpTThostFtdcBillGenStatusType = map[TThostFtdcBillGenStatusType]string{
	THOST_FTDC_BGS_None:        "未生成",
	THOST_FTDC_BGS_NoGenerated: "生成中",
	THOST_FTDC_BGS_Generated:   "已生成",
}
...
var mpTThostFtdcAlgoTypeType = map[TThostFtdcAlgoTypeType]string{
	THOST_FTDC_AT_HandlePositionAlgo: "持仓处理算法",
	THOST_FTDC_AT_FindMarginRateAlgo: "寻找保证金率算法",
}
...
var mpTThostFtdcHandlePositionAlgoIDType = map[TThostFtdcHandlePositionAlgoIDType]string{
	THOST_FTDC_HPA_Base: "基本",
	THOST_FTDC_HPA_DCE:  "大连商品交易所",
	THOST_FTDC_HPA_CZCE: "郑州商品交易所",
}
...
var mpTThostFtdcFindMarginRateAlgoIDType = map[TThostFtdcFindMarginRateAlgoIDType]string{
	THOST_FTDC_FMRA_Base: "基本",
	THOST_FTDC_FMRA_DCE:  "大连商品交易所",
	THOST_FTDC_FMRA_CZCE: "郑州商品交易所",
}
...
var mpTThostFtdcHandleTradingAccountAlgoIDType = map[TThostFtdcHandleTradingAccountAlgoIDType]string{
	THOST_FTDC_HTAA_Base: "基本",
	THOST_FTDC_HTAA_DCE:  "大连商品交易所",
	THOST_FTDC_HTAA_CZCE: "郑州商品交易所",
}
...
var mpTThostFtdcPersonTypeType = map[TThostFtdcPersonTypeType]string{
	THOST_FTDC_PST_Order:              "指定下单人",
	THOST_FTDC_PST_Open:               "开户授权人",
	THOST_FTDC_PST_Fund:               "资金调拨人",
	THOST_FTDC_PST_Settlement:         "结算单确认人",
	THOST_FTDC_PST_Company:            "法人",
	THOST_FTDC_PST_Corporation:        "法人代表",
	THOST_FTDC_PST_LinkMan:            "投资者联系人",
	THOST_FTDC_PST_Ledger:             "分户管理资产负责人",
	THOST_FTDC_PST_Trustee:            "托（保）管人",
	THOST_FTDC_PST_TrusteeCorporation: "托（保）管机构法人代表",
	THOST_FTDC_PST_TrusteeOpen:        "托（保）管机构开户授权人",
	THOST_FTDC_PST_TrusteeContact:     "托（保）管机构联系人",
	THOST_FTDC_PST_ForeignerRefer:     "境外自然人参考证件",
	THOST_FTDC_PST_CorporationRefer:   "法人代表参考证件",
}
...
var mpTThostFtdcQueryInvestorRangeType = map[TThostFtdcQueryInvestorRangeType]string{
	THOST_FTDC_QIR_All:    "所有",
	THOST_FTDC_QIR_Group:  "查询分类",
	THOST_FTDC_QIR_Single: "单一投资者",
}
...
var mpTThostFtdcInvestorRiskStatusType = map[TThostFtdcInvestorRiskStatusType]string{
	THOST_FTDC_IRS_Normal:    "正常",
	THOST_FTDC_IRS_Warn:      "警告",
	THOST_FTDC_IRS_Call:      "追保",
	THOST_FTDC_IRS_Force:     "强平",
	THOST_FTDC_IRS_Exception: "异常",
}
...
var mpTThostFtdcUserEventTypeType = map[TThostFtdcUserEventTypeType]string{
	THOST_FTDC_UET_Login:          "登录",
	THOST_FTDC_UET_Logout:         "登出",
	THOST_FTDC_UET_Trading:        "交易成功",
	THOST_FTDC_UET_TradingError:   "交易失败",
	THOST_FTDC_UET_UpdatePassword: "修改密码",
	THOST_FTDC_UET_Authenticate:   "客户端认证",
	THOST_FTDC_UET_SubmitSysInfo:  "终端信息上报",
	THOST_FTDC_UET_Transfer:       "转账",
	THOST_FTDC_UET_Other:          "其他",
}
...
var mpTThostFtdcCloseStyleType = map[TThostFtdcCloseStyleType]string{
	THOST_FTDC_ICS_Close:      "先开先平",
	THOST_FTDC_ICS_CloseToday: "先平今再平昨",
}
...
var mpTThostFtdcStatModeType = map[TThostFtdcStatModeType]string{
	THOST_FTDC_SM_Non:        "----",
	THOST_FTDC_SM_Instrument: "按合约统计",
	THOST_FTDC_SM_Product:    "按产品统计",
	THOST_FTDC_SM_Investor:   "按投资者统计",
}
...
var mpTThostFtdcParkedOrderStatusType = map[TThostFtdcParkedOrderStatusType]string{
	THOST_FTDC_PAOS_NotSend: "未发送",
	THOST_FTDC_PAOS_Send:    "已发送",
	THOST_FTDC_PAOS_Deleted: "已删除",
}
...
var mpTThostFtdcVirDealStatusType = map[TThostFtdcVirDealStatusType]string{
	THOST_FTDC_VDS_Dealing:      "正在处理",
	THOST_FTDC_VDS_DeaclSucceed: "处理成功",
}
...
var mpTThostFtdcOrgSystemIDType = map[TThostFtdcOrgSystemIDType]string{
	THOST_FTDC_ORGS_Standard:   "综合交易平台",
	THOST_FTDC_ORGS_ESunny:     "易盛系统",
	THOST_FTDC_ORGS_KingStarV6: "金仕达V6系统",
}
...
var mpTThostFtdcVirTradeStatusType = map[TThostFtdcVirTradeStatusType]string{
	THOST_FTDC_VTS_NaturalDeal:  "正常处理中",
	THOST_FTDC_VTS_SucceedEnd:   "成功结束",
	THOST_FTDC_VTS_FailedEND:    "失败结束",
	THOST_FTDC_VTS_Exception:    "异常中",
	THOST_FTDC_VTS_ManualDeal:   "已人工异常处理",
	THOST_FTDC_VTS_MesException: "通讯异常 ，请人工处理",
	THOST_FTDC_VTS_SysException: "系统出错，请人工处理",
}
...
var mpTThostFtdcVirBankAccTypeType = map[TThostFtdcVirBankAccTypeType]string{
	THOST_FTDC_VBAT_BankBook:   "存折",
	THOST_FTDC_VBAT_BankCard:   "储蓄卡",
	THOST_FTDC_VBAT_CreditCard: "信用卡",
}
...
var mpTThostFtdcVirementStatusType = map[TThostFtdcVirementStatusType]string{
	THOST_FTDC_VMS_Natural:  "正常",
	THOST_FTDC_VMS_Canceled: "销户",
}
...
var mpTThostFtdcVirementAvailAbilityType = map[TThostFtdcVirementAvailAbilityType]string{
	THOST_FTDC_VAA_NoAvailAbility: "未确认",
	THOST_FTDC_VAA_AvailAbility:   "有效",
	THOST_FTDC_VAA_Repeal:         "冲正",
}
...
var mpTThostFtdcVirementTradeCodeType = map[TThostFtdcVirementTradeCodeType]string{
	THOST_FTDC_VTC_BankBankToFuture:   "银行发起银行资金转期货",
	THOST_FTDC_VTC_BankFutureToBank:   "银行发起期货资金转银行",
	THOST_FTDC_VTC_FutureBankToFuture: "期货发起银行资金转期货",
	THOST_FTDC_VTC_FutureFutureToBank: "期货发起期货资金转银行",
}
...
var mpTThostFtdcAMLGenStatusType = map[TThostFtdcAMLGenStatusType]string{
	THOST_FTDC_GEN_Program:  "程序生成",
	THOST_FTDC_GEN_HandWork: "人工生成",
}
...
var mpTThostFtdcCFMMCKeyKindType = map[TThostFtdcCFMMCKeyKindType]string{
	THOST_FTDC_CFMMCKK_REQUEST: "主动请求更新",
	THOST_FTDC_CFMMCKK_AUTO:    "CFMMC自动更新",
	THOST_FTDC_CFMMCKK_MANUAL:  "CFMMC手动更新",
}
...
var mpTThostFtdcCertificationTypeType = map[TThostFtdcCertificationTypeType]string{
	THOST_FTDC_CFT_IDCard:                "身份证",
	THOST_FTDC_CFT_Passport:              "护照",
	THOST_FTDC_CFT_OfficerIDCard:         "军官证",
	THOST_FTDC_CFT_SoldierIDCard:         "士兵证",
	THOST_FTDC_CFT_HomeComingCard:        "回乡证",
	THOST_FTDC_CFT_HouseholdRegister:     "户口簿",
	THOST_FTDC_CFT_LicenseNo:             "营业执照号",
	THOST_FTDC_CFT_InstitutionCodeCard:   "组织机构代码证",
	THOST_FTDC_CFT_TempLicenseNo:         "临时营业执照号",
	THOST_FTDC_CFT_NoEnterpriseLicenseNo: "民办非企业登记证书",
	THOST_FTDC_CFT_OtherCard:             "其他证件",
	THOST_FTDC_CFT_SuperDepAgree:         "主管部门批文",
}
...
var mpTThostFtdcFileBusinessCodeType = map[TThostFtdcFileBusinessCodeType]string{
	THOST_FTDC_FBC_Others:                         "其他",
	THOST_FTDC_FBC_TransferDetails:                "转账交易明细对账",
	THOST_FTDC_FBC_CustAccStatus:                  "客户账户状态对账",
	THOST_FTDC_FBC_AccountTradeDetails:            "账户类交易明细对账",
	THOST_FTDC_FBC_FutureAccountChangeInfoDetails: "期货账户信息变更明细对账",
	THOST_FTDC_FBC_CustMoneyDetail:                "客户资金台账余额明细对账",
	THOST_FTDC_FBC_CustCancelAccountInfo:          "客户销户结息明细对账",
	THOST_FTDC_FBC_CustMoneyResult:                "客户资金余额对账结果",
	THOST_FTDC_FBC_OthersExceptionResult:          "其它对账异常结果文件",
	THOST_FTDC_FBC_CustInterestNetMoneyDetails:    "客户结息净额明细",
	THOST_FTDC_FBC_CustMoneySendAndReceiveDetails: "客户资金交收明细",
	THOST_FTDC_FBC_CorporationMoneyTotal:          "法人存管银行资金交收汇总",
	THOST_FTDC_FBC_MainbodyMoneyTotal:             "主体间资金交收汇总",
	THOST_FTDC_FBC_MainPartMonitorData:            "总分平衡监管数据",
	THOST_FTDC_FBC_PreparationMoney:               "存管银行备付金余额",
	THOST_FTDC_FBC_BankMoneyMonitorData:           "协办存管银行资金监管数据",
}
...
var mpTThostFtdcCashExchangeCodeType = map[TThostFtdcCashExchangeCodeType]string{
	THOST_FTDC_CEC_Exchange: "汇",
	THOST_FTDC_CEC_Cash:     "钞",
}
...
var mpTThostFtdcYesNoIndicatorType = map[TThostFtdcYesNoIndicatorType]string{
	THOST_FTDC_YNI_Yes: "是",
	THOST_FTDC_YNI_No:  "否",
}
...
var mpTThostFtdcBanlanceTypeType = map[TThostFtdcBanlanceTypeType]string{
	THOST_FTDC_BLT_CurrentMoney:   "当前余额",
	THOST_FTDC_BLT_UsableMoney:    "可用余额",
	THOST_FTDC_BLT_FetchableMoney: "可取余额",
	THOST_FTDC_BLT_FreezeMoney:    "冻结余额",
}
...
var mpTThostFtdcGenderType = map[TThostFtdcGenderType]string{
	THOST_FTDC_GD_Unknown: "未知状态",
	THOST_FTDC_GD_Male:    "男",
	THOST_FTDC_GD_Female:  "女",
}
...
var mpTThostFtdcFeePayFlagType = map[TThostFtdcFeePayFlagType]string{
	THOST_FTDC_FPF_BEN: "由受益方支付费用",
	THOST_FTDC_FPF_OUR: "由发送方支付费用",
	THOST_FTDC_FPF_SHA: "由发送方支付发起的费用，受益方支付接受的费用",
}
...
var mpTThostFtdcPassWordKeyTypeType = map[TThostFtdcPassWordKeyTypeType]string{
	THOST_FTDC_PWKT_ExchangeKey: "交换密钥",
	THOST_FTDC_PWKT_PassWordKey: "密码密钥",
	THOST_FTDC_PWKT_MACKey:      "MAC密钥",
	THOST_FTDC_PWKT_MessageKey:  "报文密钥",
}
...
var mpTThostFtdcFBTPassWordTypeType = map[TThostFtdcFBTPassWordTypeType]string{
	THOST_FTDC_PWT_Query:    "查询",
	THOST_FTDC_PWT_Fetch:    "取款",
	THOST_FTDC_PWT_Transfer: "转帐",
	THOST_FTDC_PWT_Trade:    "交易",
}
...
var mpTThostFtdcFBTEncryModeType = map[TThostFtdcFBTEncryModeType]string{
	THOST_FTDC_EM_NoEncry: "不加密",
	THOST_FTDC_EM_DES:     "DES",
	THOST_FTDC_EM_3DES:    "3DES",
}
...
var mpTThostFtdcBankRepealFlagType = map[TThostFtdcBankRepealFlagType]string{
	THOST_FTDC_BRF_BankNotNeedRepeal: "银行无需自动冲正",
	THOST_FTDC_BRF_BankWaitingRepeal: "银行待自动冲正",
	THOST_FTDC_BRF_BankBeenRepealed:  "银行已自动冲正",
}
...
var mpTThostFtdcBrokerRepealFlagType = map[TThostFtdcBrokerRepealFlagType]string{
	THOST_FTDC_BRORF_BrokerNotNeedRepeal: "期商无需自动冲正",
	THOST_FTDC_BRORF_BrokerWaitingRepeal: "期商待自动冲正",
	THOST_FTDC_BRORF_BrokerBeenRepealed:  "期商已自动冲正",
}
...
var mpTThostFtdcInstitutionTypeType = map[TThostFtdcInstitutionTypeType]string{
	THOST_FTDC_TS_Bank:   "银行",
	THOST_FTDC_TS_Future: "期商",
	THOST_FTDC_TS_Store:  "券商",
}
...
var mpTThostFtdcLastFragmentType = map[TThostFtdcLastFragmentType]string{
	THOST_FTDC_LF_Yes: "是最后分片",
	THOST_FTDC_LF_No:  "不是最后分片",
}
...
var mpTThostFtdcBankAccStatusType = map[TThostFtdcBankAccStatusType]string{
	THOST_FTDC_BAS_Normal:     "正常",
	THOST_FTDC_BAS_Freeze:     "冻结",
	THOST_FTDC_BAS_ReportLoss: "挂失",
}
...
var mpTThostFtdcMoneyAccountStatusType = map[TThostFtdcMoneyAccountStatusType]string{
	THOST_FTDC_MAS_Normal: "正常",
	THOST_FTDC_MAS_Cancel: "销户",
}
...
var mpTThostFtdcManageStatusType = map[TThostFtdcManageStatusType]string{
	THOST_FTDC_MSS_Point:       "指定存管",
	THOST_FTDC_MSS_PrePoint:    "预指定",
	THOST_FTDC_MSS_CancelPoint: "撤销指定",
}
...
var mpTThostFtdcSystemTypeType = map[TThostFtdcSystemTypeType]string{
	THOST_FTDC_SYT_FutureBankTransfer: "银期转帐",
	THOST_FTDC_SYT_StockBankTransfer:  "银证转帐",
	THOST_FTDC_SYT_TheThirdPartStore:  "第三方存管",
}
...
var mpTThostFtdcTxnEndFlagType = map[TThostFtdcTxnEndFlagType]string{
	THOST_FTDC_TEF_NormalProcessing:             "正常处理中",
	THOST_FTDC_TEF_Success:                      "成功结束",
	THOST_FTDC_TEF_Failed:                       "失败结束",
	THOST_FTDC_TEF_Abnormal:                     "异常中",
	THOST_FTDC_TEF_ManualProcessedForException:  "已人工异常处理",
	THOST_FTDC_TEF_CommuFailedNeedManualProcess: "通讯异常 ，请人工处理",
	THOST_FTDC_TEF_SysErrorNeedManualProcess:    "系统出错，请人工处理",
}
...
var mpTThostFtdcProcessStatusType = map[TThostFtdcProcessStatusType]string{
	THOST_FTDC_PSS_NotProcess:   "未处理",
	THOST_FTDC_PSS_StartProcess: "开始处理",
	THOST_FTDC_PSS_Finished:     "处理完成",
}
...
var mpTThostFtdcCustTypeType = map[TThostFtdcCustTypeType]string{
	THOST_FTDC_CUSTT_Person:      "自然人",
	THOST_FTDC_CUSTT_Institution: "机构户",
}
...
var mpTThostFtdcFBTTransferDirectionType = map[TThostFtdcFBTTransferDirectionType]string{
	THOST_FTDC_FBTTD_FromBankToFuture: "入金，银行转期货",
	THOST_FTDC_FBTTD_FromFutureToBank: "出金，期货转银行",
}
...
var mpTThostFtdcOpenOrDestroyType = map[TThostFtdcOpenOrDestroyType]string{
	THOST_FTDC_OOD_Open:    "开户",
	THOST_FTDC_OOD_Destroy: "销户",
}
...
var mpTThostFtdcAvailabilityFlagType = map[TThostFtdcAvailabilityFlagType]string{
	THOST_FTDC_AVAF_Invalid: "未确认",
	THOST_FTDC_AVAF_Valid:   "有效",
	THOST_FTDC_AVAF_Repeal:  "冲正",
}
...
var mpTThostFtdcOrganTypeType = map[TThostFtdcOrganTypeType]string{
	THOST_FTDC_OT_Bank:      "银行代理",
	THOST_FTDC_OT_Future:    "交易前置",
	THOST_FTDC_OT_PlateForm: "银期转帐平台管理",
}
...
var mpTThostFtdcOrganLevelType = map[TThostFtdcOrganLevelType]string{
	THOST_FTDC_OL_HeadQuarters: "银行总行或期商总部",
	THOST_FTDC_OL_Branch:       "银行分中心或期货公司营业部",
}
...
var mpTThostFtdcProtocalIDType = map[TThostFtdcProtocalIDType]string{
	THOST_FTDC_PID_FutureProtocal:       "期商协议",
	THOST_FTDC_PID_ICBCProtocal:         "工行协议",
	THOST_FTDC_PID_ABCProtocal:          "农行协议",
	THOST_FTDC_PID_CBCProtocal:          "中国银行协议",
	THOST_FTDC_PID_CCBProtocal:          "建行协议",
	THOST_FTDC_PID_BOCOMProtocal:        "交行协议",
	THOST_FTDC_PID_FBTPlateFormProtocal: "银期转帐平台协议",
}
...
var mpTThostFtdcConnectModeType = map[TThostFtdcConnectModeType]string{
	THOST_FTDC_CM_ShortConnect: "短连接",
	THOST_FTDC_CM_LongConnect:  "长连接",
}
...
var mpTThostFtdcSyncModeType = map[TThostFtdcSyncModeType]string{
	THOST_FTDC_SRM_ASync: "异步",
	THOST_FTDC_SRM_Sync:  "同步",
}
...
var mpTThostFtdcBankAccTypeType = map[TThostFtdcBankAccTypeType]string{
	THOST_FTDC_BAT_BankBook:   "银行存折",
	THOST_FTDC_BAT_SavingCard: "储蓄卡",
	THOST_FTDC_BAT_CreditCard: "信用卡",
}
...
var mpTThostFtdcFutureAccTypeType = map[TThostFtdcFutureAccTypeType]string{
	THOST_FTDC_FAT_BankBook:   "银行存折",
	THOST_FTDC_FAT_SavingCard: "储蓄卡",
	THOST_FTDC_FAT_CreditCard: "信用卡",
}
...
var mpTThostFtdcOrganStatusType = map[TThostFtdcOrganStatusType]string{
	THOST_FTDC_OS_Ready:            "启用",
	THOST_FTDC_OS_CheckIn:          "签到",
	THOST_FTDC_OS_CheckOut:         "签退",
	THOST_FTDC_OS_CheckFileArrived: "对帐文件到达",
	THOST_FTDC_OS_CheckDetail:      "对帐",
	THOST_FTDC_OS_DayEndClean:      "日终清理",
	THOST_FTDC_OS_Invalid:          "注销",
}
...
var mpTThostFtdcCCBFeeModeType = map[TThostFtdcCCBFeeModeType]string{
	THOST_FTDC_CCBFM_ByAmount: "按金额扣收",
	THOST_FTDC_CCBFM_ByMonth:  "按月扣收",
}
...
var mpTThostFtdcCommApiTypeType = map[TThostFtdcCommApiTypeType]string{
	THOST_FTDC_CAPIT_Client:  "客户端",
	THOST_FTDC_CAPIT_Server:  "服务端",
	THOST_FTDC_CAPIT_UserApi: "交易系统的UserApi",
}
...
var mpTThostFtdcLinkStatusType = map[TThostFtdcLinkStatusType]string{
	THOST_FTDC_LS_Connected:    "已经连接",
	THOST_FTDC_LS_Disconnected: "没有连接",
}
...
var mpTThostFtdcPwdFlagType = map[TThostFtdcPwdFlagType]string{
	THOST_FTDC_BPWDF_NoCheck:      "不核对",
	THOST_FTDC_BPWDF_BlankCheck:   "明文核对",
	THOST_FTDC_BPWDF_EncryptCheck: "密文核对",
}
...
var mpTThostFtdcSecuAccTypeType = map[TThostFtdcSecuAccTypeType]string{
	THOST_FTDC_SAT_AccountID:       "资金帐号",
	THOST_FTDC_SAT_CardID:          "资金卡号",
	THOST_FTDC_SAT_SHStockholderID: "上海股东帐号",
	THOST_FTDC_SAT_SZStockholderID: "深圳股东帐号",
}
...
var mpTThostFtdcTransferStatusType = map[TThostFtdcTransferStatusType]string{
	THOST_FTDC_TRFS_Normal:   "正常",
	THOST_FTDC_TRFS_Repealed: "被冲正",
}
...
var mpTThostFtdcSponsorTypeType = map[TThostFtdcSponsorTypeType]string{
	THOST_FTDC_SPTYPE_Broker: "期商",
	THOST_FTDC_SPTYPE_Bank:   "银行",
}
...
var mpTThostFtdcReqRspTypeType = map[TThostFtdcReqRspTypeType]string{
	THOST_FTDC_REQRSP_Request:  "请求",
	THOST_FTDC_REQRSP_Response: "响应",
}
...
var mpTThostFtdcFBTUserEventTypeType = map[TThostFtdcFBTUserEventTypeType]string{
	THOST_FTDC_FBTUET_SignIn:                    "签到",
	THOST_FTDC_FBTUET_FromBankToFuture:          "银行转期货",
	THOST_FTDC_FBTUET_FromFutureToBank:          "期货转银行",
	THOST_FTDC_FBTUET_OpenAccount:               "开户",
	THOST_FTDC_FBTUET_CancelAccount:             "销户",
	THOST_FTDC_FBTUET_ChangeAccount:             "变更银行账户",
	THOST_FTDC_FBTUET_RepealFromBankToFuture:    "冲正银行转期货",
	THOST_FTDC_FBTUET_RepealFromFutureToBank:    "冲正期货转银行",
	THOST_FTDC_FBTUET_QueryBankAccount:          "查询银行账户",
	THOST_FTDC_FBTUET_QueryFutureAccount:        "查询期货账户",
	THOST_FTDC_FBTUET_SignOut:                   "签退",
	THOST_FTDC_FBTUET_SyncKey:                   "密钥同步",
	THOST_FTDC_FBTUET_ReserveOpenAccount:        "预约开户",
	THOST_FTDC_FBTUET_CancelReserveOpenAccount:  "撤销预约开户",
	THOST_FTDC_FBTUET_ReserveOpenAccountConfirm: "预约开户确认",
	THOST_FTDC_FBTUET_Other:                     "其他",
}
...
var mpTThostFtdcDBOperationType = map[TThostFtdcDBOperationType]string{
	THOST_FTDC_DBOP_Insert: "插入",
	THOST_FTDC_DBOP_Update: "更新",
	THOST_FTDC_DBOP_Delete: "删除",
}
...
var mpTThostFtdcSyncFlagType = map[TThostFtdcSyncFlagType]string{
	THOST_FTDC_SYNF_Yes: "已同步",
	THOST_FTDC_SYNF_No:  "未同步",
}
...
var mpTThostFtdcSyncTypeType = map[TThostFtdcSyncTypeType]string{
	THOST_FTDC_SYNT_OneOffSync:    "一次同步",
	THOST_FTDC_SYNT_TimerSync:     "定时同步",
	THOST_FTDC_SYNT_TimerFullSync: "定时完全同步",
}
...
var mpTThostFtdcExDirectionType = map[TThostFtdcExDirectionType]string{
	THOST_FTDC_FBEDIR_Settlement: "结汇",
	THOST_FTDC_FBEDIR_Sale:       "售汇",
}
...
var mpTThostFtdcFBEResultFlagType = map[TThostFtdcFBEResultFlagType]string{
	THOST_FTDC_FBERES_Success:             "成功",
	THOST_FTDC_FBERES_InsufficientBalance: "账户余额不足",
	THOST_FTDC_FBERES_UnknownTrading:      "交易结果未知",
	THOST_FTDC_FBERES_Fail:                "失败",
}
...
var mpTThostFtdcFBEExchStatusType = map[TThostFtdcFBEExchStatusType]string{
	THOST_FTDC_FBEES_Normal:     "正常",
	THOST_FTDC_FBEES_ReExchange: "交易重发",
}
...
var mpTThostFtdcFBEFileFlagType = map[TThostFtdcFBEFileFlagType]string{
	THOST_FTDC_FBEFG_DataPackage: "数据包",
	THOST_FTDC_FBEFG_File:        "文件",
}
...
var mpTThostFtdcFBEAlreadyTradeType = map[TThostFtdcFBEAlreadyTradeType]string{
	THOST_FTDC_FBEAT_NotTrade: "未交易",
	THOST_FTDC_FBEAT_Trade:    "已交易",
}
...
var mpTThostFtdcFBEUserEventTypeType = map[TThostFtdcFBEUserEventTypeType]string{
	THOST_FTDC_FBEUET_SignIn:           "签到",
	THOST_FTDC_FBEUET_Exchange:         "换汇",
	THOST_FTDC_FBEUET_ReExchange:       "换汇重发",
	THOST_FTDC_FBEUET_QueryBankAccount: "银行账户查询",
	THOST_FTDC_FBEUET_QueryExchDetial:  "换汇明细查询",
	THOST_FTDC_FBEUET_QueryExchSummary: "换汇汇总查询",
	THOST_FTDC_FBEUET_QueryExchRate:    "换汇汇率查询",
	THOST_FTDC_FBEUET_CheckBankAccount: "对账文件通知",
	THOST_FTDC_FBEUET_SignOut:          "签退",
	THOST_FTDC_FBEUET_Other:            "其他",
}
...
var mpTThostFtdcFBEReqFlagType = map[TThostFtdcFBEReqFlagType]string{
	THOST_FTDC_FBERF_UnProcessed: "未处理",
	THOST_FTDC_FBERF_WaitSend:    "等待发送",
	THOST_FTDC_FBERF_SendSuccess: "发送成功",
	THOST_FTDC_FBERF_SendFailed:  "发送失败",
	THOST_FTDC_FBERF_WaitReSend:  "等待重发",
}
...
var mpTThostFtdcNotifyClassType = map[TThostFtdcNotifyClassType]string{
	THOST_FTDC_NC_NOERROR:   "正常",
	THOST_FTDC_NC_Warn:      "警示",
	THOST_FTDC_NC_Call:      "追保",
	THOST_FTDC_NC_Force:     "强平",
	THOST_FTDC_NC_CHUANCANG: "穿仓",
	THOST_FTDC_NC_Exception: "异常",
}
...
var mpTThostFtdcForceCloseTypeType = map[TThostFtdcForceCloseTypeType]string{
	THOST_FTDC_FCT_Manual: "手工强平",
	THOST_FTDC_FCT_Single: "单一投资者辅助强平",
	THOST_FTDC_FCT_Group:  "批量投资者辅助强平",
}
...
var mpTThostFtdcRiskNotifyMethodType = map[TThostFtdcRiskNotifyMethodType]string{
	THOST_FTDC_RNM_System: "系统通知",
	THOST_FTDC_RNM_SMS:    "短信通知",
	THOST_FTDC_RNM_EMail:  "邮件通知",
	THOST_FTDC_RNM_Manual: "人工通知",
}
...
var mpTThostFtdcRiskNotifyStatusType = map[TThostFtdcRiskNotifyStatusType]string{
	THOST_FTDC_RNS_NotGen:    "未生成",
	THOST_FTDC_RNS_Generated: "已生成未发送",
	THOST_FTDC_RNS_SendError: "发送失败",
	THOST_FTDC_RNS_SendOk:    "已发送未接收",
	THOST_FTDC_RNS_Received:  "已接收未确认",
	THOST_FTDC_RNS_Confirmed: "已确认",
}
...
var mpTThostFtdcRiskUserEventType = map[TThostFtdcRiskUserEventType]string{
	THOST_FTDC_RUE_ExportData: "导出数据",
}
...
var mpTThostFtdcConditionalOrderSortTypeType = map[TThostFtdcConditionalOrderSortTypeType]string{
	THOST_FTDC_COST_LastPriceAsc:  "使用最新价升序",
	THOST_FTDC_COST_LastPriceDesc: "使用最新价降序",
	THOST_FTDC_COST_AskPriceAsc:   "使用卖价升序",
	THOST_FTDC_COST_AskPriceDesc:  "使用卖价降序",
	THOST_FTDC_COST_BidPriceAsc:   "使用买价升序",
	THOST_FTDC_COST_BidPriceDesc:  "使用买价降序",
}
...
var mpTThostFtdcSendTypeType = map[TThostFtdcSendTypeType]string{
	THOST_FTDC_UOAST_NoSend:    "未发送",
	THOST_FTDC_UOAST_Sended:    "已发送",
	THOST_FTDC_UOAST_Generated: "已生成",
	THOST_FTDC_UOAST_SendFail:  "报送失败",
	THOST_FTDC_UOAST_Success:   "接收成功",
	THOST_FTDC_UOAST_Fail:      "接收失败",
	THOST_FTDC_UOAST_Cancel:    "取消报送",
}
...
var mpTThostFtdcClientIDStatusType = map[TThostFtdcClientIDStatusType]string{
	THOST_FTDC_UOACS_NoApply:  "未申请",
	THOST_FTDC_UOACS_Submited: "已提交申请",
	THOST_FTDC_UOACS_Sended:   "已发送申请",
	THOST_FTDC_UOACS_Success:  "完成",
	THOST_FTDC_UOACS_Refuse:   "拒绝",
	THOST_FTDC_UOACS_Cancel:   "已撤销编码",
}
...
var mpTThostFtdcQuestionTypeType = map[TThostFtdcQuestionTypeType]string{
	THOST_FTDC_QT_Radio:  "单选",
	THOST_FTDC_QT_Option: "多选",
	THOST_FTDC_QT_Blank:  "填空",
}
...
var mpTThostFtdcBusinessTypeType = map[TThostFtdcBusinessTypeType]string{
	THOST_FTDC_BT_Request:  "请求",
	THOST_FTDC_BT_Response: "应答",
	THOST_FTDC_BT_Notice:   "通知",
}
...
var mpTThostFtdcCfmmcReturnCodeType = map[TThostFtdcCfmmcReturnCodeType]string{
	THOST_FTDC_CRC_Success:    "成功",
	THOST_FTDC_CRC_Working:    "该客户已经有流程在处理中",
	THOST_FTDC_CRC_InfoFail:   "监控中客户资料检查失败",
	THOST_FTDC_CRC_IDCardFail: "监控中实名制检查失败",
	THOST_FTDC_CRC_OtherFail:  "其他错误",
}
...
var mpTThostFtdcClientTypeType = map[TThostFtdcClientTypeType]string{
	THOST_FTDC_CfMMCCT_All:          "所有",
	THOST_FTDC_CfMMCCT_Person:       "个人",
	THOST_FTDC_CfMMCCT_Company:      "单位",
	THOST_FTDC_CfMMCCT_Other:        "其他",
	THOST_FTDC_CfMMCCT_SpecialOrgan: "特殊法人",
	THOST_FTDC_CfMMCCT_Asset:        "资管户",
}
...
var mpTThostFtdcExchangeIDTypeType = map[TThostFtdcExchangeIDTypeType]string{
	THOST_FTDC_EIDT_SHFE:  "上海期货交易所",
	THOST_FTDC_EIDT_CZCE:  "郑州商品交易所",
	THOST_FTDC_EIDT_DCE:   "大连商品交易所",
	THOST_FTDC_EIDT_CFFEX: "中国金融期货交易所",
	THOST_FTDC_EIDT_INE:   "上海国际能源交易中心股份有限公司",
}
...
var mpTThostFtdcExClientIDTypeType = map[TThostFtdcExClientIDTypeType]string{
	THOST_FTDC_ECIDT_Hedge:       "套保",
	THOST_FTDC_ECIDT_Arbitrage:   "套利",
	THOST_FTDC_ECIDT_Speculation: "投机",
}
...
var mpTThostFtdcUpdateFlagType = map[TThostFtdcUpdateFlagType]string{
	THOST_FTDC_UF_NoUpdate:  "未更新",
	THOST_FTDC_UF_Success:   "更新全部信息成功",
	THOST_FTDC_UF_Fail:      "更新全部信息失败",
	THOST_FTDC_UF_TCSuccess: "更新交易编码成功",
	THOST_FTDC_UF_TCFail:    "更新交易编码失败",
	THOST_FTDC_UF_Cancel:    "已丢弃",
}
...
var mpTThostFtdcApplyOperateIDType = map[TThostFtdcApplyOperateIDType]string{
	THOST_FTDC_AOID_OpenInvestor:        "开户",
	THOST_FTDC_AOID_ModifyIDCard:        "修改身份信息",
	THOST_FTDC_AOID_ModifyNoIDCard:      "修改一般信息",
	THOST_FTDC_AOID_ApplyTradingCode:    "申请交易编码",
	THOST_FTDC_AOID_CancelTradingCode:   "撤销交易编码",
	THOST_FTDC_AOID_CancelInvestor:      "销户",
	THOST_FTDC_AOID_FreezeAccount:       "账户休眠",
	THOST_FTDC_AOID_ActiveFreezeAccount: "激活休眠账户",
}
...
var mpTThostFtdcApplyStatusIDType = map[TThostFtdcApplyStatusIDType]string{
	THOST_FTDC_ASID_NoComplete: "未补全",
	THOST_FTDC_ASID_Submited:   "已提交",
	THOST_FTDC_ASID_Checked:    "已审核",
	THOST_FTDC_ASID_Refused:    "已拒绝",
	THOST_FTDC_ASID_Deleted:    "已删除",
}
...
var mpTThostFtdcSendMethodType = map[TThostFtdcSendMethodType]string{
	THOST_FTDC_UOASM_ByAPI:  "文件发送",
	THOST_FTDC_UOASM_ByFile: "电子发送",
}
...
var mpTThostFtdcEventModeType = map[TThostFtdcEventModeType]string{
	THOST_FTDC_EvM_ADD:     "增加",
	THOST_FTDC_EvM_UPDATE:  "修改",
	THOST_FTDC_EvM_DELETE:  "删除",
	THOST_FTDC_EvM_CHECK:   "复核",
	THOST_FTDC_EvM_COPY:    "复制",
	THOST_FTDC_EvM_CANCEL:  "注销",
	THOST_FTDC_EvM_Reverse: "冲销",
}
...
var mpTThostFtdcUOAAutoSendType = map[TThostFtdcUOAAutoSendType]string{
	THOST_FTDC_UOAA_ASR:  "自动发送并接收",
	THOST_FTDC_UOAA_ASNR: "自动发送，不自动接收",
	THOST_FTDC_UOAA_NSAR: "不自动发送，自动接收",
	THOST_FTDC_UOAA_NSR:  "不自动发送，也不自动接收",
}
...
var mpTThostFtdcFlowIDType = map[TThostFtdcFlowIDType]string{
	THOST_FTDC_EvM_InvestorGroupFlow:     "投资者对应投资者组设置",
	THOST_FTDC_EvM_InvestorRate:          "投资者手续费率设置",
	THOST_FTDC_EvM_InvestorCommRateModel: "投资者手续费率模板关系设置",
}
...
var mpTThostFtdcCheckLevelType = map[TThostFtdcCheckLevelType]string{
	THOST_FTDC_CL_Zero: "零级复核",
	THOST_FTDC_CL_One:  "一级复核",
	THOST_FTDC_CL_Two:  "二级复核",
}
...
var mpTThostFtdcCheckStatusType = map[TThostFtdcCheckStatusType]string{
	THOST_FTDC_CHS_Init:     "未复核",
	THOST_FTDC_CHS_Checking: "复核中",
	THOST_FTDC_CHS_Checked:  "已复核",
	THOST_FTDC_CHS_Refuse:   "拒绝",
	THOST_FTDC_CHS_Cancel:   "作废",
}
...
var mpTThostFtdcUsedStatusType = map[TThostFtdcUsedStatusType]string{
	THOST_FTDC_CHU_Unused: "未生效",
	THOST_FTDC_CHU_Used:   "已生效",
	THOST_FTDC_CHU_Fail:   "生效失败",
}
...
var mpTThostFtdcBankAcountOriginType = map[TThostFtdcBankAcountOriginType]string{
	THOST_FTDC_BAO_ByAccProperty: "手工录入",
	THOST_FTDC_BAO_ByFBTransfer:  "银期转账",
}
...
var mpTThostFtdcMonthBillTradeSumType = map[TThostFtdcMonthBillTradeSumType]string{
	THOST_FTDC_MBTS_ByInstrument: "同日同合约",
	THOST_FTDC_MBTS_ByDayInsPrc:  "同日同合约同价格",
	THOST_FTDC_MBTS_ByDayIns:     "同合约",
}
...
var mpTThostFtdcFBTTradeCodeEnumType = map[TThostFtdcFBTTradeCodeEnumType]string{
	THOST_FTDC_FTC_BankLaunchBankToBroker:   "银行发起银行转期货",
	THOST_FTDC_FTC_BrokerLaunchBankToBroker: "期货发起银行转期货",
	THOST_FTDC_FTC_BankLaunchBrokerToBank:   "银行发起期货转银行",
	THOST_FTDC_FTC_BrokerLaunchBrokerToBank: "期货发起期货转银行",
}
...
var mpTThostFtdcOTPTypeType = map[TThostFtdcOTPTypeType]string{
	THOST_FTDC_OTP_NONE: "无动态令牌",
	THOST_FTDC_OTP_TOTP: "时间令牌",
}
...
var mpTThostFtdcOTPStatusType = map[TThostFtdcOTPStatusType]string{
	THOST_FTDC_OTPS_Unused: "未使用",
	THOST_FTDC_OTPS_Used:   "已使用",
	THOST_FTDC_OTPS_Disuse: "注销",
}
...
var mpTThostFtdcBrokerUserTypeType = map[TThostFtdcBrokerUserTypeType]string{
	THOST_FTDC_BUT_Investor:   "投资者",
	THOST_FTDC_BUT_BrokerUser: "操作员",
}
...
var mpTThostFtdcFutureTypeType = map[TThostFtdcFutureTypeType]string{
	THOST_FTDC_FUTT_Commodity: "商品期货",
	THOST_FTDC_FUTT_Financial: "金融期货",
}
...
var mpTThostFtdcFundEventTypeType = map[TThostFtdcFundEventTypeType]string{
	THOST_FTDC_FET_Restriction:         "转账限额",
	THOST_FTDC_FET_TodayRestriction:    "当日转账限额",
	THOST_FTDC_FET_Transfer:            "期商流水",
	THOST_FTDC_FET_Credit:              "资金冻结",
	THOST_FTDC_FET_InvestorWithdrawAlm: "投资者可提资金比例",
	THOST_FTDC_FET_BankRestriction:     "单个银行帐户转账限额",
	THOST_FTDC_FET_Accountregister:     "银期签约账户",
	THOST_FTDC_FET_ExchangeFundIO:      "交易所出入金",
	THOST_FTDC_FET_InvestorFundIO:      "投资者出入金",
}
...
var mpTThostFtdcAccountSourceTypeType = map[TThostFtdcAccountSourceTypeType]string{
	THOST_FTDC_AST_FBTransfer:  "银期同步",
	THOST_FTDC_AST_ManualEntry: "手工录入",
}
...
var mpTThostFtdcCodeSourceTypeType = map[TThostFtdcCodeSourceTypeType]string{
	THOST_FTDC_CST_UnifyAccount: "统一开户(已规范)",
	THOST_FTDC_CST_ManualEntry:  "手工录入(未规范)",
}
...
var mpTThostFtdcUserRangeType = map[TThostFtdcUserRangeType]string{
	THOST_FTDC_UR_All:    "所有",
	THOST_FTDC_UR_Single: "单一操作员",
}
...
var mpTThostFtdcByGroupType = map[TThostFtdcByGroupType]string{
	THOST_FTDC_BG_Investor: "按投资者统计",
	THOST_FTDC_BG_Group:    "按类统计",
}
...
var mpTThostFtdcTradeSumStatModeType = map[TThostFtdcTradeSumStatModeType]string{
	THOST_FTDC_TSSM_Instrument: "按合约统计",
	THOST_FTDC_TSSM_Product:    "按产品统计",
	THOST_FTDC_TSSM_Exchange:   "按交易所统计",
}
...
var mpTThostFtdcExprSetModeType = map[TThostFtdcExprSetModeType]string{
	THOST_FTDC_ESM_Relative: "相对已有规则设置",
	THOST_FTDC_ESM_Typical:  "典型设置",
}
...
var mpTThostFtdcRateInvestorRangeType = map[TThostFtdcRateInvestorRangeType]string{
	THOST_FTDC_RIR_All:    "公司标准",
	THOST_FTDC_RIR_Model:  "模板",
	THOST_FTDC_RIR_Single: "单一投资者",
}
...
var mpTThostFtdcSyncDataStatusType = map[TThostFtdcSyncDataStatusType]string{
	THOST_FTDC_SDS_Initialize:    "未同步",
	THOST_FTDC_SDS_Settlementing: "同步中",
	THOST_FTDC_SDS_Settlemented:  "已同步",
}
...
var mpTThostFtdcTradeSourceType = map[TThostFtdcTradeSourceType]string{
	THOST_FTDC_TSRC_NORMAL: "来自交易所普通回报",
	THOST_FTDC_TSRC_QUERY:  "来自查询",
}
...
var mpTThostFtdcFlexStatModeType = map[TThostFtdcFlexStatModeType]string{
	THOST_FTDC_FSM_Product:  "产品统计",
	THOST_FTDC_FSM_Exchange: "交易所统计",
	THOST_FTDC_FSM_All:      "统计所有",
}
...
var mpTThostFtdcByInvestorRangeType = map[TThostFtdcByInvestorRangeType]string{
	THOST_FTDC_BIR_Property: "属性统计",
	THOST_FTDC_BIR_All:      "统计所有",
}
...
var mpTThostFtdcPropertyInvestorRangeType = map[TThostFtdcPropertyInvestorRangeType]string{
	THOST_FTDC_PIR_All:      "所有",
	THOST_FTDC_PIR_Property: "投资者属性",
	THOST_FTDC_PIR_Single:   "单一投资者",
}
...
var mpTThostFtdcFileStatusType = map[TThostFtdcFileStatusType]string{
	THOST_FTDC_FIS_NoCreate: "未生成",
	THOST_FTDC_FIS_Created:  "已生成",
	THOST_FTDC_FIS_Failed:   "生成失败",
}
...
var mpTThostFtdcFileGenStyleType = map[TThostFtdcFileGenStyleType]string{
	THOST_FTDC_FGS_FileTransmit: "下发",
	THOST_FTDC_FGS_FileGen:      "生成",
}
...
var mpTThostFtdcSysOperModeType = map[TThostFtdcSysOperModeType]string{
	THOST_FTDC_SoM_Add:    "增加",
	THOST_FTDC_SoM_Update: "修改",
	THOST_FTDC_SoM_Delete: "删除",
	THOST_FTDC_SoM_Copy:   "复制",
	THOST_FTDC_SoM_AcTive: "激活",
	THOST_FTDC_SoM_CanCel: "注销",
	THOST_FTDC_SoM_ReSet:  "重置",
}
...
var mpTThostFtdcSysOperTypeType = map[TThostFtdcSysOperTypeType]string{
	THOST_FTDC_SoT_UpdatePassword:          "修改操作员密码",
	THOST_FTDC_SoT_UserDepartment:          "操作员组织架构关系",
	THOST_FTDC_SoT_RoleManager:             "角色管理",
	THOST_FTDC_SoT_RoleFunction:            "角色功能设置",
	THOST_FTDC_SoT_BaseParam:               "基础参数设置",
	THOST_FTDC_SoT_SetUserID:               "设置操作员",
	THOST_FTDC_SoT_SetUserRole:             "用户角色设置",
	THOST_FTDC_SoT_UserIpRestriction:       "用户IP限制",
	THOST_FTDC_SoT_DepartmentManager:       "组织架构管理",
	THOST_FTDC_SoT_DepartmentCopy:          "组织架构向查询分类复制",
	THOST_FTDC_SoT_Tradingcode:             "交易编码管理",
	THOST_FTDC_SoT_InvestorStatus:          "投资者状态维护",
	THOST_FTDC_SoT_InvestorAuthority:       "投资者权限管理",
	THOST_FTDC_SoT_PropertySet:             "属性设置",
	THOST_FTDC_SoT_ReSetInvestorPasswd:     "重置投资者密码",
	THOST_FTDC_SoT_InvestorPersonalityInfo: "投资者个性信息维护",
}
...
var mpTThostFtdcCSRCDataQueyTypeType = map[TThostFtdcCSRCDataQueyTypeType]string{
	THOST_FTDC_CSRCQ_Current: "查询当前交易日报送的数据",
	THOST_FTDC_CSRCQ_History: "查询历史报送的代理经纪公司的数据",
}
...
var mpTThostFtdcFreezeStatusType = map[TThostFtdcFreezeStatusType]string{
	THOST_FTDC_FRS_Normal: "活跃",
	THOST_FTDC_FRS_Freeze: "休眠",
}
...
var mpTThostFtdcStandardStatusType = map[TThostFtdcStandardStatusType]string{
	THOST_FTDC_STST_Standard:    "已规范",
	THOST_FTDC_STST_NonStandard: "未规范",
}
...
var mpTThostFtdcRightParamTypeType = map[TThostFtdcRightParamTypeType]string{
	THOST_FTDC_RPT_Freeze:           "休眠户",
	THOST_FTDC_RPT_FreezeActive:     "激活休眠户",
	THOST_FTDC_RPT_OpenLimit:        "开仓权限限制",
	THOST_FTDC_RPT_RelieveOpenLimit: "解除开仓权限限制",
}
...
var mpTThostFtdcDataStatusType = map[TThostFtdcDataStatusType]string{
	THOST_FTDC_AMLDS_Normal:  "正常",
	THOST_FTDC_AMLDS_Deleted: "已删除",
}
...
var mpTThostFtdcAMLCheckStatusType = map[TThostFtdcAMLCheckStatusType]string{
	THOST_FTDC_AMLCHS_Init:         "未复核",
	THOST_FTDC_AMLCHS_Checking:     "复核中",
	THOST_FTDC_AMLCHS_Checked:      "已复核",
	THOST_FTDC_AMLCHS_RefuseReport: "拒绝上报",
}
...
var mpTThostFtdcAmlDateTypeType = map[TThostFtdcAmlDateTypeType]string{
	THOST_FTDC_AMLDT_DrawDay:  "检查日期",
	THOST_FTDC_AMLDT_TouchDay: "发生日期",
}
...
var mpTThostFtdcAmlCheckLevelType = map[TThostFtdcAmlCheckLevelType]string{
	THOST_FTDC_AMLCL_CheckLevel0: "零级审核",
	THOST_FTDC_AMLCL_CheckLevel1: "一级审核",
	THOST_FTDC_AMLCL_CheckLevel2: "二级审核",
	THOST_FTDC_AMLCL_CheckLevel3: "三级审核",
}
...
var mpTThostFtdcExportFileTypeType = map[TThostFtdcExportFileTypeType]string{
	THOST_FTDC_EFT_CSV:   "CSV",
	THOST_FTDC_EFT_EXCEL: "Excel",
	THOST_FTDC_EFT_DBF:   "DBF",
}
...
var mpTThostFtdcSettleManagerTypeType = map[TThostFtdcSettleManagerTypeType]string{
	THOST_FTDC_SMT_Before:       "结算前准备",
	THOST_FTDC_SMT_Settlement:   "结算",
	THOST_FTDC_SMT_After:        "结算后核对",
	THOST_FTDC_SMT_Settlemented: "结算后处理",
}
...
var mpTThostFtdcSettleManagerLevelType = map[TThostFtdcSettleManagerLevelType]string{
	THOST_FTDC_SML_Must:   "必要",
	THOST_FTDC_SML_Alarm:  "警告",
	THOST_FTDC_SML_Prompt: "提示",
	THOST_FTDC_SML_Ignore: "不检查",
}
...
var mpTThostFtdcSettleManagerGroupType = map[TThostFtdcSettleManagerGroupType]string{
	THOST_FTDC_SMG_Exhcange: "交易所核对",
	THOST_FTDC_SMG_ASP:      "内部核对",
	THOST_FTDC_SMG_CSRC:     "上报数据核对",
}
...
var mpTThostFtdcLimitUseTypeType = map[TThostFtdcLimitUseTypeType]string{
	THOST_FTDC_LUT_Repeatable:   "可重复使用",
	THOST_FTDC_LUT_Unrepeatable: "不可重复使用",
}
...
var mpTThostFtdcDataResourceType = map[TThostFtdcDataResourceType]string{
	THOST_FTDC_DAR_Settle:   "本系统",
	THOST_FTDC_DAR_Exchange: "交易所",
	THOST_FTDC_DAR_CSRC:     "报送数据",
}
...
var mpTThostFtdcMarginTypeType = map[TThostFtdcMarginTypeType]string{
	THOST_FTDC_MGT_ExchMarginRate:       "交易所保证金率",
	THOST_FTDC_MGT_InstrMarginRate:      "投资者保证金率",
	THOST_FTDC_MGT_InstrMarginRateTrade: "投资者交易保证金率",
}
...
var mpTThostFtdcActiveTypeType = map[TThostFtdcActiveTypeType]string{
	THOST_FTDC_ACT_Intraday: "仅当日生效",
	THOST_FTDC_ACT_Long:     "长期生效",
}
...
var mpTThostFtdcMarginRateTypeType = map[TThostFtdcMarginRateTypeType]string{
	THOST_FTDC_MRT_Exchange:      "交易所保证金率",
	THOST_FTDC_MRT_Investor:      "投资者保证金率",
	THOST_FTDC_MRT_InvestorTrade: "投资者交易保证金率",
}
...
var mpTThostFtdcBackUpStatusType = map[TThostFtdcBackUpStatusType]string{
	THOST_FTDC_BUS_UnBak:   "未生成备份数据",
	THOST_FTDC_BUS_BakUp:   "备份数据生成中",
	THOST_FTDC_BUS_BakUped: "已生成备份数据",
	THOST_FTDC_BUS_BakFail: "备份数据失败",
}
...
var mpTThostFtdcInitSettlementType = map[TThostFtdcInitSettlementType]string{
	THOST_FTDC_SIS_UnInitialize: "结算初始化未开始",
	THOST_FTDC_SIS_Initialize:   "结算初始化中",
	THOST_FTDC_SIS_Initialized:  "结算初始化完成",
}
...
var mpTThostFtdcReportStatusType = map[TThostFtdcReportStatusType]string{
	THOST_FTDC_SRS_NoCreate:   "未生成报表数据",
	THOST_FTDC_SRS_Create:     "报表数据生成中",
	THOST_FTDC_SRS_Created:    "已生成报表数据",
	THOST_FTDC_SRS_CreateFail: "生成报表数据失败",
}
...
var mpTThostFtdcSaveStatusType = map[TThostFtdcSaveStatusType]string{
	THOST_FTDC_SSS_UnSaveData: "归档未完成",
	THOST_FTDC_SSS_SaveDatad:  "归档完成",
}
...
var mpTThostFtdcSettArchiveStatusType = map[TThostFtdcSettArchiveStatusType]string{
	THOST_FTDC_SAS_UnArchived:  "未归档数据",
	THOST_FTDC_SAS_Archiving:   "数据归档中",
	THOST_FTDC_SAS_Archived:    "已归档数据",
	THOST_FTDC_SAS_ArchiveFail: "归档数据失败",
}
...
var mpTThostFtdcCTPTypeType = map[TThostFtdcCTPTypeType]string{
	THOST_FTDC_CTPT_Unkown:     "未知类型",
	THOST_FTDC_CTPT_MainCenter: "主中心",
	THOST_FTDC_CTPT_BackUp:     "备中心",
}
...
var mpTThostFtdcCloseDealTypeType = map[TThostFtdcCloseDealTypeType]string{
	THOST_FTDC_CDT_Normal:    "正常",
	THOST_FTDC_CDT_SpecFirst: "投机平仓优先",
}
...
var mpTThostFtdcMortgageFundUseRangeType = map[TThostFtdcMortgageFundUseRangeType]string{
	THOST_FTDC_MFUR_None:   "不能使用",
	THOST_FTDC_MFUR_Margin: "用于保证金",
	THOST_FTDC_MFUR_All:    "用于手续费、盈亏、保证金",
	THOST_FTDC_MFUR_CNY3:   "人民币方案3",
}
...
var mpTThostFtdcSpecProductTypeType = map[TThostFtdcSpecProductTypeType]string{
	THOST_FTDC_SPT_CzceHedge:          "郑商所套保产品",
	THOST_FTDC_SPT_IneForeignCurrency: "货币质押产品",
	THOST_FTDC_SPT_DceOpenClose:       "大连短线开平仓产品",
}
...
var mpTThostFtdcFundMortgageTypeType = map[TThostFtdcFundMortgageTypeType]string{
	THOST_FTDC_FMT_Mortgage:   "质押",
	THOST_FTDC_FMT_Redemption: "解质",
}
...
var mpTThostFtdcAccountSettlementParamIDType = map[TThostFtdcAccountSettlementParamIDType]string{
	THOST_FTDC_ASPI_BaseMargin:     "基础保证金",
	THOST_FTDC_ASPI_LowestInterest: "最低权益标准",
}
...
var mpTThostFtdcFundMortDirectionType = map[TThostFtdcFundMortDirectionType]string{
	THOST_FTDC_FMD_In:  "货币质入",
	THOST_FTDC_FMD_Out: "货币质出",
}
...
var mpTThostFtdcBusinessClassType = map[TThostFtdcBusinessClassType]string{
	THOST_FTDC_BT_Profit: "盈利",
	THOST_FTDC_BT_Loss:   "亏损",
	THOST_FTDC_BT_Other:  "其他",
}
...
var mpTThostFtdcSwapSourceTypeType = map[TThostFtdcSwapSourceTypeType]string{
	THOST_FTDC_SST_Manual:    "手工",
	THOST_FTDC_SST_Automatic: "自动生成",
}
...
var mpTThostFtdcCurrExDirectionType = map[TThostFtdcCurrExDirectionType]string{
	THOST_FTDC_CED_Settlement: "结汇",
	THOST_FTDC_CED_Sale:       "售汇",
}
...
var mpTThostFtdcCurrencySwapStatusType = map[TThostFtdcCurrencySwapStatusType]string{
	THOST_FTDC_CSS_Entry:   "已录入",
	THOST_FTDC_CSS_Approve: "已审核",
	THOST_FTDC_CSS_Refuse:  "已拒绝",
	THOST_FTDC_CSS_Revoke:  "已撤销",
	THOST_FTDC_CSS_Send:    "已发送",
	THOST_FTDC_CSS_Success: "换汇成功",
	THOST_FTDC_CSS_Failure: "换汇失败",
}
...
var mpTThostFtdcReqFlagType = map[TThostFtdcReqFlagType]string{
	THOST_FTDC_REQF_NoSend:      "未发送",
	THOST_FTDC_REQF_SendSuccess: "发送成功",
	THOST_FTDC_REQF_SendFailed:  "发送失败",
	THOST_FTDC_REQF_WaitReSend:  "等待重发",
}
...
var mpTThostFtdcResFlagType = map[TThostFtdcResFlagType]string{
	THOST_FTDC_RESF_Success:      "成功",
	THOST_FTDC_RESF_InsuffiCient: "账户余额不足",
	THOST_FTDC_RESF_UnKnown:      "交易结果未知",
}
...
var mpTThostFtdcExStatusType = map[TThostFtdcExStatusType]string{
	THOST_FTDC_EXS_Before: "修改前",
	THOST_FTDC_EXS_After:  "修改后",
}
...
var mpTThostFtdcClientRegionType = map[TThostFtdcClientRegionType]string{
	THOST_FTDC_CR_Domestic: "国内客户",
	THOST_FTDC_CR_GMT:      "港澳台客户",
	THOST_FTDC_CR_Foreign:  "国外客户",
}
...
var mpTThostFtdcHasBoardType = map[TThostFtdcHasBoardType]string{
	THOST_FTDC_HB_No:  "没有",
	THOST_FTDC_HB_Yes: "有",
}
...
var mpTThostFtdcStartModeType = map[TThostFtdcStartModeType]string{
	THOST_FTDC_SM_Normal:  "正常",
	THOST_FTDC_SM_Emerge:  "应急",
	THOST_FTDC_SM_Restore: "恢复",
}
...
var mpTThostFtdcTemplateTypeType = map[TThostFtdcTemplateTypeType]string{
	THOST_FTDC_TPT_Full:      "全量",
	THOST_FTDC_TPT_Increment: "增量",
	THOST_FTDC_TPT_BackUp:    "备份",
}
...
var mpTThostFtdcLoginModeType = map[TThostFtdcLoginModeType]string{
	THOST_FTDC_LM_Trade:    "交易",
	THOST_FTDC_LM_Transfer: "转账",
}
...
var mpTThostFtdcPromptTypeType = map[TThostFtdcPromptTypeType]string{
	THOST_FTDC_CPT_Instrument: "合约上下市",
	THOST_FTDC_CPT_Margin:     "保证金分段生效",
}
...
var mpTThostFtdcHasTrusteeType = map[TThostFtdcHasTrusteeType]string{
	THOST_FTDC_HT_Yes: "有",
	THOST_FTDC_HT_No:  "没有",
}
...
var mpTThostFtdcAmTypeType = map[TThostFtdcAmTypeType]string{
	THOST_FTDC_AMT_Bank:       "银行",
	THOST_FTDC_AMT_Securities: "证券公司",
	THOST_FTDC_AMT_Fund:       "基金公司",
	THOST_FTDC_AMT_Insurance:  "保险公司",
	THOST_FTDC_AMT_Trust:      "信托公司",
	THOST_FTDC_AMT_Other:      "其他",
}
...
var mpTThostFtdcCSRCFundIOTypeType = map[TThostFtdcCSRCFundIOTypeType]string{
	THOST_FTDC_CFIOT_FundIO:       "出入金",
	THOST_FTDC_CFIOT_SwapCurrency: "银期换汇",
}
...
var mpTThostFtdcCusAccountTypeType = map[TThostFtdcCusAccountTypeType]string{
	THOST_FTDC_CAT_Futures:          "期货结算账户",
	THOST_FTDC_CAT_AssetmgrFuture:   "纯期货资管业务下的资管结算账户",
	THOST_FTDC_CAT_AssetmgrTrustee:  "综合类资管业务下的期货资管托管账户",
	THOST_FTDC_CAT_AssetmgrTransfer: "综合类资管业务下的资金中转账户",
}
...
var mpTThostFtdcLanguageTypeType = map[TThostFtdcLanguageTypeType]string{
	THOST_FTDC_LT_Chinese: "中文",
	THOST_FTDC_LT_English: "英文",
}
...
var mpTThostFtdcAssetmgrClientTypeType = map[TThostFtdcAssetmgrClientTypeType]string{
	THOST_FTDC_AMCT_Person:       "个人资管客户",
	THOST_FTDC_AMCT_Organ:        "单位资管客户",
	THOST_FTDC_AMCT_SpecialOrgan: "特殊单位资管客户",
}
...
var mpTThostFtdcAssetmgrTypeType = map[TThostFtdcAssetmgrTypeType]string{
	THOST_FTDC_ASST_Futures:      "期货类",
	THOST_FTDC_ASST_SpecialOrgan: "综合类",
}
...
var mpTThostFtdcCheckInstrTypeType = map[TThostFtdcCheckInstrTypeType]string{
	THOST_FTDC_CIT_HasExch: "合约交易所不存在",
	THOST_FTDC_CIT_HasATP:  "合约本系统不存在",
	THOST_FTDC_CIT_HasDiff: "合约比较不一致",
}
...
var mpTThostFtdcDeliveryTypeType = map[TThostFtdcDeliveryTypeType]string{
	THOST_FTDC_DT_HandDeliv:   "手工交割",
	THOST_FTDC_DT_PersonDeliv: "到期交割",
}
...
var mpTThostFtdcMaxMarginSideAlgorithmType = map[TThostFtdcMaxMarginSideAlgorithmType]string{
	THOST_FTDC_MMSA_NO:  "不使用大额单边保证金算法",
	THOST_FTDC_MMSA_YES: "使用大额单边保证金算法",
}
...
var mpTThostFtdcDAClientTypeType = map[TThostFtdcDAClientTypeType]string{
	THOST_FTDC_CACT_Person:  "自然人",
	THOST_FTDC_CACT_Company: "法人",
	THOST_FTDC_CACT_Other:   "其他",
}
...
var mpTThostFtdcUOAAssetmgrTypeType = map[TThostFtdcUOAAssetmgrTypeType]string{
	THOST_FTDC_UOAAT_Futures:      "期货类",
	THOST_FTDC_UOAAT_SpecialOrgan: "综合类",
}
...
var mpTThostFtdcDirectionEnType = map[TThostFtdcDirectionEnType]string{
	THOST_FTDC_DEN_Buy:  "Buy",
	THOST_FTDC_DEN_Sell: "Sell",
}
...
var mpTThostFtdcOffsetFlagEnType = map[TThostFtdcOffsetFlagEnType]string{
	THOST_FTDC_OFEN_Open:            "Position Opening",
	THOST_FTDC_OFEN_Close:           "Position Close",
	THOST_FTDC_OFEN_ForceClose:      "Forced Liquidation",
	THOST_FTDC_OFEN_CloseToday:      "Close Today",
	THOST_FTDC_OFEN_CloseYesterday:  "Close Prev.",
	THOST_FTDC_OFEN_ForceOff:        "Forced Reduction",
	THOST_FTDC_OFEN_LocalForceClose: "Local Forced Liquidation",
}
...
var mpTThostFtdcHedgeFlagEnType = map[TThostFtdcHedgeFlagEnType]string{
	THOST_FTDC_HFEN_Speculation: "Speculation",
	THOST_FTDC_HFEN_Arbitrage:   "Arbitrage",
	THOST_FTDC_HFEN_Hedge:       "Hedge",
}
...
var mpTThostFtdcFundIOTypeEnType = map[TThostFtdcFundIOTypeEnType]string{
	THOST_FTDC_FIOTEN_FundIO:       "Deposit/Withdrawal",
	THOST_FTDC_FIOTEN_Transfer:     "Bank-Futures Transfer",
	THOST_FTDC_FIOTEN_SwapCurrency: "Bank-Futures FX Exchange",
}
...
var mpTThostFtdcFundTypeEnType = map[TThostFtdcFundTypeEnType]string{
	THOST_FTDC_FTEN_Deposite:      "Bank Deposit",
	THOST_FTDC_FTEN_ItemFund:      "Payment/Fee",
	THOST_FTDC_FTEN_Company:       "Brokerage Adj",
	THOST_FTDC_FTEN_InnerTransfer: "Internal Transfer",
}
...
var mpTThostFtdcFundDirectionEnType = map[TThostFtdcFundDirectionEnType]string{
	THOST_FTDC_FDEN_In:  "Deposit",
	THOST_FTDC_FDEN_Out: "Withdrawal",
}
...
var mpTThostFtdcFundMortDirectionEnType = map[TThostFtdcFundMortDirectionEnType]string{
	THOST_FTDC_FMDEN_In:  "Pledge",
	THOST_FTDC_FMDEN_Out: "Redemption",
}
...
var mpTThostFtdcOptionsTypeType = map[TThostFtdcOptionsTypeType]string{
	THOST_FTDC_CP_CallOptions: "看涨",
	THOST_FTDC_CP_PutOptions:  "看跌",
}
...
var mpTThostFtdcStrikeModeType = map[TThostFtdcStrikeModeType]string{
	THOST_FTDC_STM_Continental: "欧式",
	THOST_FTDC_STM_American:    "美式",
	THOST_FTDC_STM_Bermuda:     "百慕大",
}
...
var mpTThostFtdcStrikeTypeType = map[TThostFtdcStrikeTypeType]string{
	THOST_FTDC_STT_Hedge: "自身对冲",
	THOST_FTDC_STT_Match: "匹配执行",
}
...
var mpTThostFtdcApplyTypeType = map[TThostFtdcApplyTypeType]string{
	THOST_FTDC_APPT_NotStrikeNum: "不执行数量",
}
...
var mpTThostFtdcGiveUpDataSourceType = map[TThostFtdcGiveUpDataSourceType]string{
	THOST_FTDC_GUDS_Gen:  "系统生成",
	THOST_FTDC_GUDS_Hand: "手工添加",
}
...
var mpTThostFtdcExecResultType = map[TThostFtdcExecResultType]string{
	THOST_FTDC_OER_NoExec:               "没有执行",
	THOST_FTDC_OER_Canceled:             "已经取消",
	THOST_FTDC_OER_OK:                   "执行成功",
	THOST_FTDC_OER_NoPosition:           "期权持仓不够",
	THOST_FTDC_OER_NoDeposit:            "资金不够",
	THOST_FTDC_OER_NoParticipant:        "会员不存在",
	THOST_FTDC_OER_NoClient:             "客户不存在",
	THOST_FTDC_OER_NoInstrument:         "合约不存在",
	THOST_FTDC_OER_NoRight:              "没有执行权限",
	THOST_FTDC_OER_InvalidVolume:        "不合理的数量",
	THOST_FTDC_OER_NoEnoughHistoryTrade: "没有足够的历史成交",
	THOST_FTDC_OER_Unknown:              "未知",
}
...
var mpTThostFtdcCombinationTypeType = map[TThostFtdcCombinationTypeType]string{
	THOST_FTDC_COMBT_Future: "期货组合",
	THOST_FTDC_COMBT_BUL:    "垂直价差BUL",
	THOST_FTDC_COMBT_BER:    "垂直价差BER",
	THOST_FTDC_COMBT_STD:    "跨式组合",
	THOST_FTDC_COMBT_STG:    "宽跨式组合",
	THOST_FTDC_COMBT_PRT:    "备兑组合",
	THOST_FTDC_COMBT_CAS:    "时间价差组合",
	THOST_FTDC_COMBT_OPL:    "期权对锁组合",
	THOST_FTDC_COMBT_BFO:    "买备兑组合",
	THOST_FTDC_COMBT_BLS:    "买入期权垂直价差组合",
	THOST_FTDC_COMBT_BES:    "卖出期权垂直价差组合",
}
...
var mpTThostFtdcDceCombinationTypeType = map[TThostFtdcDceCombinationTypeType]string{
	THOST_FTDC_DCECOMBT_SPL: "期货对锁组合",
	THOST_FTDC_DCECOMBT_OPL: "期权对锁组合",
	THOST_FTDC_DCECOMBT_SP:  "期货跨期组合",
	THOST_FTDC_DCECOMBT_SPC: "期货跨品种组合",
	THOST_FTDC_DCECOMBT_BLS: "买入期权垂直价差组合",
	THOST_FTDC_DCECOMBT_BES: "卖出期权垂直价差组合",
	THOST_FTDC_DCECOMBT_CAS: "期权日历价差组合",
	THOST_FTDC_DCECOMBT_STD: "期权跨式组合",
	THOST_FTDC_DCECOMBT_STG: "期权宽跨式组合",
	THOST_FTDC_DCECOMBT_BFO: "买入期货期权组合",
	THOST_FTDC_DCECOMBT_SFO: "卖出期货期权组合",
}
...
var mpTThostFtdcOptionRoyaltyPriceTypeType = map[TThostFtdcOptionRoyaltyPriceTypeType]string{
	THOST_FTDC_ORPT_PreSettlementPrice:    "昨结算价",
	THOST_FTDC_ORPT_OpenPrice:             "开仓价",
	THOST_FTDC_ORPT_MaxPreSettlementPrice: "最新价与昨结算价较大值",
}
...
var mpTThostFtdcBalanceAlgorithmType = map[TThostFtdcBalanceAlgorithmType]string{
	THOST_FTDC_BLAG_Default:           "不计算期权市值盈亏",
	THOST_FTDC_BLAG_IncludeOptValLost: "计算期权市值亏损",
}
...
var mpTThostFtdcActionTypeType = map[TThostFtdcActionTypeType]string{
	THOST_FTDC_ACTP_Exec:    "执行",
	THOST_FTDC_ACTP_Abandon: "放弃",
}
...
var mpTThostFtdcForQuoteStatusType = map[TThostFtdcForQuoteStatusType]string{
	THOST_FTDC_FQST_Submitted: "已经提交",
	THOST_FTDC_FQST_Accepted:  "已经接受",
	THOST_FTDC_FQST_Rejected:  "已经被拒绝",
}
...
var mpTThostFtdcValueMethodType = map[TThostFtdcValueMethodType]string{
	THOST_FTDC_VM_Absolute: "按绝对值",
	THOST_FTDC_VM_Ratio:    "按比率",
}
...
var mpTThostFtdcExecOrderPositionFlagType = map[TThostFtdcExecOrderPositionFlagType]string{
	THOST_FTDC_EOPF_Reserve:   "保留",
	THOST_FTDC_EOPF_UnReserve: "不保留",
}
...
var mpTThostFtdcExecOrderCloseFlagType = map[TThostFtdcExecOrderCloseFlagType]string{
	THOST_FTDC_EOCF_AutoClose:  "自动平仓",
	THOST_FTDC_EOCF_NotToClose: "免于自动平仓",
}
...
var mpTThostFtdcProductTypeType = map[TThostFtdcProductTypeType]string{
	THOST_FTDC_PTE_Futures: "期货",
	THOST_FTDC_PTE_Options: "期权",
}
...
var mpTThostFtdcCZCEUploadFileNameType = map[TThostFtdcCZCEUploadFileNameType]string{
	THOST_FTDC_CUFN_CUFN_O: "^ d{8}_zz_ d{4}",
	THOST_FTDC_CUFN_CUFN_T: "^ d{8}成交表",
	THOST_FTDC_CUFN_CUFN_P: "^ d{8}单腿持仓表new",
	THOST_FTDC_CUFN_CUFN_N: "^ d{8}非平仓了结表",
	THOST_FTDC_CUFN_CUFN_L: "^ d{8}平仓表",
	THOST_FTDC_CUFN_CUFN_F: "^ d{8}资金表",
	THOST_FTDC_CUFN_CUFN_C: "^ d{8}组合持仓表",
	THOST_FTDC_CUFN_CUFN_M: "^ d{8}保证金参数表",
}
...
var mpTThostFtdcDCEUploadFileNameType = map[TThostFtdcDCEUploadFileNameType]string{
	THOST_FTDC_DUFN_DUFN_O: "^ d{8}_dl_ d{3}",
	THOST_FTDC_DUFN_DUFN_T: "^ d{8}_成交表",
	THOST_FTDC_DUFN_DUFN_P: "^ d{8}_持仓表",
	THOST_FTDC_DUFN_DUFN_F: "^ d{8}_资金结算表",
	THOST_FTDC_DUFN_DUFN_C: "^ d{8}_优惠组合持仓明细表",
	THOST_FTDC_DUFN_DUFN_D: "^ d{8}_持仓明细表",
	THOST_FTDC_DUFN_DUFN_M: "^ d{8}_保证金参数表",
	THOST_FTDC_DUFN_DUFN_S: "^ d{8}_期权执行表",
}
...
var mpTThostFtdcSHFEUploadFileNameType = map[TThostFtdcSHFEUploadFileNameType]string{
	THOST_FTDC_SUFN_SUFN_O: "^ d{4}_ d{8}_ d{8}_DailyFundChg",
	THOST_FTDC_SUFN_SUFN_T: "^ d{4}_ d{8}_ d{8}_Trade",
	THOST_FTDC_SUFN_SUFN_P: "^ d{4}_ d{8}_ d{8}_SettlementDetail",
	THOST_FTDC_SUFN_SUFN_F: "^ d{4}_ d{8}_ d{8}_Capital",
}
...
var mpTThostFtdcCFFEXUploadFileNameType = map[TThostFtdcCFFEXUploadFileNameType]string{
	THOST_FTDC_CFUFN_SUFN_T: "^ d{4}_SG d{1}_ d{8}_ d{1}_Trade",
	THOST_FTDC_CFUFN_SUFN_P: "^ d{4}_SG d{1}_ d{8}_ d{1}_SettlementDetail",
	THOST_FTDC_CFUFN_SUFN_F: "^ d{4}_SG d{1}_ d{8}_ d{1}_Capital",
	THOST_FTDC_CFUFN_SUFN_S: "^ d{4}_SG d{1}_ d{8}_ d{1}_OptionExec",
}
...
var mpTThostFtdcCombDirectionType = map[TThostFtdcCombDirectionType]string{
	THOST_FTDC_CMDR_Comb:    "申请组合",
	THOST_FTDC_CMDR_UnComb:  "申请拆分",
	THOST_FTDC_CMDR_DelComb: "操作员删组合单",
}
...
var mpTThostFtdcStrikeOffsetTypeType = map[TThostFtdcStrikeOffsetTypeType]string{
	THOST_FTDC_STOV_RealValue:   "实值额",
	THOST_FTDC_STOV_ProfitValue: "盈利额",
	THOST_FTDC_STOV_RealRatio:   "实值比例",
	THOST_FTDC_STOV_ProfitRatio: "盈利比例",
}
...
var mpTThostFtdcReserveOpenAccStasType = map[TThostFtdcReserveOpenAccStasType]string{
	THOST_FTDC_ROAST_Processing: "等待处理中",
	THOST_FTDC_ROAST_Cancelled:  "已撤销",
	THOST_FTDC_ROAST_Opened:     "已开户",
	THOST_FTDC_ROAST_Invalid:    "无效请求",
}
...
var mpTThostFtdcWeakPasswordSourceType = map[TThostFtdcWeakPasswordSourceType]string{
	THOST_FTDC_WPSR_Lib:    "弱密码库",
	THOST_FTDC_WPSR_Manual: "手工录入",
}
...
var mpTThostFtdcOptSelfCloseFlagType = map[TThostFtdcOptSelfCloseFlagType]string{
	THOST_FTDC_OSCF_CloseSelfOptionPosition:     "自对冲期权仓位",
	THOST_FTDC_OSCF_ReserveOptionPosition:       "保留期权仓位",
	THOST_FTDC_OSCF_SellCloseSelfFuturePosition: "自对冲卖方履约后的期货仓位",
	THOST_FTDC_OSCF_ReserveFuturePosition:       "保留卖方履约后的期货仓位",
}
...
var mpTThostFtdcBizTypeType = map[TThostFtdcBizTypeType]string{
	THOST_FTDC_BZTP_Future: "期货",
	THOST_FTDC_BZTP_Stock:  "证券",
}
...
var mpTThostFtdcAppTypeType = map[TThostFtdcAppTypeType]string{
	THOST_FTDC_APP_TYPE_Investor:      "直连的投资者",
	THOST_FTDC_APP_TYPE_InvestorRelay: "为每个投资者都创建连接的中继",
	THOST_FTDC_APP_TYPE_OperatorRelay: "所有投资者共享一个操作员连接的中继",
	THOST_FTDC_APP_TYPE_UnKnown:       "未知",
}
...
var mpTThostFtdcResponseValueType = map[TThostFtdcResponseValueType]string{
	THOST_FTDC_RV_Right:  "检查成功",
	THOST_FTDC_RV_Refuse: "检查失败",
}
...
var mpTThostFtdcOTCTradeTypeType = map[TThostFtdcOTCTradeTypeType]string{
	THOST_FTDC_OTC_TRDT_Block: "大宗交易",
	THOST_FTDC_OTC_TRDT_EFP:   "期转现",
}
...
var mpTThostFtdcMatchTypeType = map[TThostFtdcMatchTypeType]string{
	THOST_FTDC_OTC_MT_DV01:     "基点价值",
	THOST_FTDC_OTC_MT_ParValue: "面值",
}
...
var mpTThostFtdcAuthTypeType = map[TThostFtdcAuthTypeType]string{
	THOST_FTDC_AU_WHITE: "白名单校验",
	THOST_FTDC_AU_BLACK: "黑名单校验",
}
...
var mpTThostFtdcClassTypeType = map[TThostFtdcClassTypeType]string{
	THOST_FTDC_INS_ALL:    "所有合约",
	THOST_FTDC_INS_FUTURE: "期货、即期、期转现、Tas、金属指数合约",
	THOST_FTDC_INS_OPTION: "期货、现货期权合约",
	THOST_FTDC_INS_COMB:   "组合合约",
}
...
var mpTThostFtdcTradingTypeType = map[TThostFtdcTradingTypeType]string{
	THOST_FTDC_TD_ALL:     "所有状态",
	THOST_FTDC_TD_TRADE:   "交易",
	THOST_FTDC_TD_UNTRADE: "非交易",
}
...
var mpTThostFtdcProductStatusType = map[TThostFtdcProductStatusType]string{
	THOST_FTDC_PS_tradeable:   "可交易",
	THOST_FTDC_PS_untradeable: "不可交易",
}
...
var mpTThostFtdcSyncDeltaStatusType = map[TThostFtdcSyncDeltaStatusType]string{
	THOST_FTDC_SDS_Readable: "交易可读",
	THOST_FTDC_SDS_Reading:  "交易在读",
	THOST_FTDC_SDS_Readend:  "交易读取完成",
	THOST_FTDC_SDS_OptErr:   "追平失败 交易本地状态结算不存在",
}
...
var mpTThostFtdcActionDirectionType = map[TThostFtdcActionDirectionType]string{
	THOST_FTDC_ACD_Add: "增加",
	THOST_FTDC_ACD_Del: "删除",
	THOST_FTDC_ACD_Upd: "更新",
}
...
var mpTThostFtdcOrderCancelAlgType = map[TThostFtdcOrderCancelAlgType]string{
	THOST_FTDC_OAC_Balance:   "轮询席位撤单",
	THOST_FTDC_OAC_OrigFirst: "优先原报单席位撤单",
}
...
var mpTThostFtdcOpenLimitControlLevelType = map[TThostFtdcOpenLimitControlLevelType]string{
	THOST_FTDC_PLCL_None:    "不控制",
	THOST_FTDC_PLCL_Product: "产品级别",
	THOST_FTDC_PLCL_Inst:    "合约级别",
}
...
var mpTThostFtdcOrderFreqControlLevelType = map[TThostFtdcOrderFreqControlLevelType]string{
	THOST_FTDC_OFCL_None:    "不控制",
	THOST_FTDC_OFCL_Product: "产品级别",
	THOST_FTDC_OFCL_Inst:    "合约级别",
}
...
var mpTThostFtdcEnumBoolType = map[TThostFtdcEnumBoolType]string{
	THOST_FTDC_EBL_False: "false",
	THOST_FTDC_EBL_True:  "true",
}
...
var mpTThostFtdcTimeRangeType = map[TThostFtdcTimeRangeType]string{
	THOST_FTDC_ETR_USUAL: "一般月份",
	THOST_FTDC_ETR_FNSP:  "交割月前一个月上半月",
	THOST_FTDC_ETR_BNSP:  "交割月前一个月下半月",
	THOST_FTDC_ETR_SPOT:  "交割月份",
}
...
var mpTThostFtdcPortfolioType = map[TThostFtdcPortfolioType]string{
	THOST_FTDC_EPF_None: "不使用新型组保算法",
	THOST_FTDC_EPF_SPBM: "SPBM算法",
}
...
func (s TThostFtdcTraderIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTraderIDType) GBString() string { return BytesToGBK(s[:]) }

// 投资者代码类型
type TThostFtdcInvestorIDType [13]byte

func (s TThostFtdcInvestorIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestorIDType) GBString() string { return BytesToGBK(s[:]) }

// 经纪公司代码类型
type TThostFtdcBrokerIDType [11]byte

func (s TThostFtdcBrokerIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBrokerIDType) GBString() string { return BytesToGBK(s[:]) }

// 经纪公司简称类型
type TThostFtdcBrokerAbbrType [9]byte

func (s TThostFtdcBrokerAbbrType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBrokerAbbrType) GBString() string { return BytesToGBK(s[:]) }

// 经纪公司名称类型
type TThostFtdcBrokerNameType [81]byte

func (s TThostFtdcBrokerNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBrokerNameType) GBString() string { return BytesToGBK(s[:]) }

// 合约在交易所的代码类型
type TThostFtdcOldExchangeInstIDType [31]byte

func (s TThostFtdcOldExchangeInstIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOldExchangeInstIDType) GBString() string { return BytesToGBK(s[:]) }

// 合约在交易所的代码类型
type TThostFtdcExchangeInstIDType [81]byte

func (s TThostFtdcExchangeInstIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcExchangeInstIDType) GBString() string { return BytesToGBK(s[:]) }

// 报单引用类型
type TThostFtdcOrderRefType [13]byte

func (s TThostFtdcOrderRefType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrderRefType) GBString() string { return BytesToGBK(s[:]) }

// 会员代码类型
type TThostFtdcParticipantIDType [11]byte

func (s TThostFtdcParticipantIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcParticipantIDType) GBString() string { return BytesToGBK(s[:]) }

// 用户代码类型
type TThostFtdcUserIDType [16]byte

func (s TThostFtdcUserIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUserIDType) GBString() string { return BytesToGBK(s[:]) }

// 密码类型
type TThostFtdcPasswordType [41]byte

func (s TThostFtdcPasswordType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPasswordType) GBString() string { return BytesToGBK(s[:]) }

// 交易编码类型
type TThostFtdcClientIDType [11]byte

func (s TThostFtdcClientIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClientIDType) GBString() string { return BytesToGBK(s[:]) }

// 合约代码类型
type TThostFtdcInstrumentIDType [81]byte

func (s TThostFtdcInstrumentIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInstrumentIDType) GBString() string { return BytesToGBK(s[:]) }

// 合约代码类型
type TThostFtdcOldInstrumentIDType [31]byte

func (s TThostFtdcOldInstrumentIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOldInstrumentIDType) GBString() string { return BytesToGBK(s[:]) }

// 合约标识码类型
type TThostFtdcInstrumentCodeType [31]byte

func (s TThostFtdcInstrumentCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInstrumentCodeType) GBString() string { return BytesToGBK(s[:]) }

// 市场代码类型
type TThostFtdcMarketIDType [31]byte

func (s TThostFtdcMarketIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcMarketIDType) GBString() string { return BytesToGBK(s[:]) }

// 产品名称类型
type TThostFtdcProductNameType [21]byte

func (s TThostFtdcProductNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProductNameType) GBString() string { return BytesToGBK(s[:]) }

// 交易所代码类型
type TThostFtdcExchangeIDType [9]byte

func (s TThostFtdcExchangeIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcExchangeIDType) GBString() string { return BytesToGBK(s[:]) }

// 交易所名称类型
type TThostFtdcExchangeNameType [61]byte

func (s TThostFtdcExchangeNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcExchangeNameType) GBString() string { return BytesToGBK(s[:]) }

// 交易所简称类型
type TThostFtdcExchangeAbbrType [9]byte

func (s TThostFtdcExchangeAbbrType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcExchangeAbbrType) GBString() string { return BytesToGBK(s[:]) }

// 交易所标志类型
type TThostFtdcExchangeFlagType [2]byte

func (s TThostFtdcExchangeFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcExchangeFlagType) GBString() string { return BytesToGBK(s[:]) }

// Mac地址类型
type TThostFtdcMacAddressType [21]byte

func (s TThostFtdcMacAddressType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcMacAddressType) GBString() string { return BytesToGBK(s[:]) }

// 系统编号类型
type TThostFtdcSystemIDType [21]byte

func (s TThostFtdcSystemIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSystemIDType) GBString() string { return BytesToGBK(s[:]) }

// 客户登录备注2类型
type TThostFtdcClientLoginRemarkType [151]byte

func (s TThostFtdcClientLoginRemarkType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClientLoginRemarkType) GBString() string { return BytesToGBK(s[:]) }

// 日期类型
type TThostFtdcDateType [9]byte

func (s TThostFtdcDateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDateType) GBString() string { return BytesToGBK(s[:]) }

// 时间类型
type TThostFtdcTimeType [9]byte

func (s TThostFtdcTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTimeType) GBString() string { return BytesToGBK(s[:]) }

// 长时间类型
type TThostFtdcLongTimeType [13]byte

func (s TThostFtdcLongTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLongTimeType) GBString() string { return BytesToGBK(s[:]) }

// 合约名称类型
type TThostFtdcInstrumentNameType [21]byte

func (s TThostFtdcInstrumentNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInstrumentNameType) GBString() string { return BytesToGBK(s[:]) }

// 结算组代码类型
type TThostFtdcSettlementGroupIDType [9]byte

func (s TThostFtdcSettlementGroupIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSettlementGroupIDType) GBString() string { return BytesToGBK(s[:]) }

// 报单编号类型
type TThostFtdcOrderSysIDType [21]byte

func (s TThostFtdcOrderSysIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrderSysIDType) GBString() string { return BytesToGBK(s[:]) }

// 成交编号类型
type TThostFtdcTradeIDType [21]byte

func (s TThostFtdcTradeIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTradeIDType) GBString() string { return BytesToGBK(s[:]) }

// DB命令类型类型
type TThostFtdcCommandTypeType [65]byte

func (s TThostFtdcCommandTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCommandTypeType) GBString() string { return BytesToGBK(s[:]) }

// IP地址类型
type TThostFtdcOldIPAddressType [16]byte

func (s TThostFtdcOldIPAddressType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOldIPAddressType) GBString() string { return BytesToGBK(s[:]) }

// IP地址类型
type TThostFtdcIPAddressType [33]byte

func (s TThostFtdcIPAddressType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIPAddressType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcProductInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProductInfoType) GBString() string { return BytesToGBK(s[:]) }

// 协议信息类型
type TThostFtdcProtocolInfoType [11]byte

func (s TThostFtdcProtocolInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProtocolInfoType) GBString() string { return BytesToGBK(s[:]) }

// 业务单元类型
type TThostFtdcBusinessUnitType [21]byte

func (s TThostFtdcBusinessUnitType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBusinessUnitType) GBString() string { return BytesToGBK(s[:]) }

// 出入金流水号类型
type TThostFtdcDepositSeqNoType [15]byte

func (s TThostFtdcDepositSeqNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDepositSeqNoType) GBString() string { return BytesToGBK(s[:]) }

// 证件号码类型
type TThostFtdcIdentifiedCardNoType [51]byte

func (s TThostFtdcIdentifiedCardNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIdentifiedCardNoType) GBString() string { return BytesToGBK(s[:]) }

// 本地报单编号类型
type TThostFtdcOrderLocalIDType [13]byte

func (s TThostFtdcOrderLocalIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrderLocalIDType) GBString() string { return BytesToGBK(s[:]) }

// 用户名称类型
type TThostFtdcUserNameType [81]byte

func (s TThostFtdcUserNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUserNameType) GBString() string { return BytesToGBK(s[:]) }

// 参与人名称类型
type TThostFtdcPartyNameType [81]byte

func (s TThostFtdcPartyNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPartyNameType) GBString() string { return BytesToGBK(s[:]) }

// 错误信息类型
type TThostFtdcErrorMsgType [81]byte

func (s TThostFtdcErrorMsgType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcErrorMsgType) GBString() string { return BytesToGBK(s[:]) }

// 字段名类型
type TThostFtdcFieldNameType [2049]byte

func (s TThostFtdcFieldNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFieldNameType) GBString() string { return BytesToGBK(s[:]) }

// 字段内容类型
type TThostFtdcFieldContentType [2049]byte

func (s TThostFtdcFieldContentType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFieldContentType) GBString() string { return BytesToGBK(s[:]) }

// 系统名称类型
type TThostFtdcSystemNameType [41]byte

func (s TThostFtdcSystemNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSystemNameType) GBString() string { return BytesToGBK(s[:]) }

// 消息正文类型
type TThostFtdcContentType [501]byte

func (s TThostFtdcContentType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcContentType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCombOffsetFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCombOffsetFlagType) GBString() string { return BytesToGBK(s[:]) }

// 组合投机套保标志类型
type TThostFtdcCombHedgeFlagType [5]byte

func (s TThostFtdcCombHedgeFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCombHedgeFlagType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcSequenceLabelType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSequenceLabelType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcContractCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcContractCodeType) GBString() string { return BytesToGBK(s[:]) }

// 市类型
type TThostFtdcCityType [51]byte

func (s TThostFtdcCityType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCityType) GBString() string { return BytesToGBK(s[:]) }

// 是否股民类型
type TThostFtdcIsStockType [11]byte

func (s TThostFtdcIsStockType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIsStockType) GBString() string { return BytesToGBK(s[:]) }

// 渠道类型
type TThostFtdcChannelType [51]byte

func (s TThostFtdcChannelType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcChannelType) GBString() string { return BytesToGBK(s[:]) }

// 通讯地址类型
type TThostFtdcAddressType [101]byte

func (s TThostFtdcAddressType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAddressType) GBString() string { return BytesToGBK(s[:]) }

// 邮政编码类型
type TThostFtdcZipCodeType [7]byte

func (s TThostFtdcZipCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcZipCodeType) GBString() string { return BytesToGBK(s[:]) }

// 联系电话类型
type TThostFtdcTelephoneType [41]byte

func (s TThostFtdcTelephoneType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTelephoneType) GBString() string { return BytesToGBK(s[:]) }

// 传真类型
type TThostFtdcFaxType [41]byte

func (s TThostFtdcFaxType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFaxType) GBString() string { return BytesToGBK(s[:]) }

// 手机类型
type TThostFtdcMobileType [41]byte

func (s TThostFtdcMobileType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcMobileType) GBString() string { return BytesToGBK(s[:]) }

// 电子邮件类型
type TThostFtdcEMailType [41]byte

func (s TThostFtdcEMailType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcEMailType) GBString() string { return BytesToGBK(s[:]) }

// 备注类型
type TThostFtdcMemoType [161]byte

func (s TThostFtdcMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcMemoType) GBString() string { return BytesToGBK(s[:]) }

// 企业代码类型
type TThostFtdcCompanyCodeType [51]byte

func (s TThostFtdcCompanyCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCompanyCodeType) GBString() string { return BytesToGBK(s[:]) }

// 网站地址类型
type TThostFtdcWebsiteType [51]byte

func (s TThostFtdcWebsiteType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcWebsiteType) GBString() string { return BytesToGBK(s[:]) }

// 税务登记号类型
type TThostFtdcTaxNoType [31]byte

func (s TThostFtdcTaxNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTaxNoType) GBString() string { return BytesToGBK(s[:]) }

// 属性代码类型
type TThostFtdcPropertyIDType [33]byte

func (s TThostFtdcPropertyIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPropertyIDType) GBString() string { return BytesToGBK(s[:]) }

// 属性名称类型
type TThostFtdcPropertyNameType [65]byte

func (s TThostFtdcPropertyNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPropertyNameType) GBString() string { return BytesToGBK(s[:]) }

// 营业执照号类型
type TThostFtdcLicenseNoType [51]byte

func (s TThostFtdcLicenseNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLicenseNoType) GBString() string { return BytesToGBK(s[:]) }

// 经纪人代码类型
type TThostFtdcAgentIDType [13]byte

func (s TThostFtdcAgentIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAgentIDType) GBString() string { return BytesToGBK(s[:]) }

// 经纪人名称类型
type TThostFtdcAgentNameType [41]byte

func (s TThostFtdcAgentNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAgentNameType) GBString() string { return BytesToGBK(s[:]) }

// 经纪人组代码类型
type TThostFtdcAgentGroupIDType [13]byte

func (s TThostFtdcAgentGroupIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAgentGroupIDType) GBString() string { return BytesToGBK(s[:]) }

// 经纪人组名称类型
type TThostFtdcAgentGroupNameType [41]byte

func (s TThostFtdcAgentGroupNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAgentGroupNameType) GBString() string { return BytesToGBK(s[:]) }

// 参数代码值类型
type TThostFtdcSettlementParamValueType [256]byte

func (s TThostFtdcSettlementParamValueType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSettlementParamValueType) GBString() string { return BytesToGBK(s[:]) }

// 计数器代码类型
type TThostFtdcCounterIDType [33]byte

func (s TThostFtdcCounterIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCounterIDType) GBString() string { return BytesToGBK(s[:]) }

// 投资者分组名称类型
type TThostFtdcInvestorGroupNameType [41]byte

func (s TThostFtdcInvestorGroupNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestorGroupNameType) GBString() string { return BytesToGBK(s[:]) }

// 牌号类型
type TThostFtdcBrandCodeType [257]byte

func (s TThostFtdcBrandCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBrandCodeType) GBString() string { return BytesToGBK(s[:]) }

// 仓库类型
type TThostFtdcWarehouseType [257]byte

func (s TThostFtdcWarehouseType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcWarehouseType) GBString() string { return BytesToGBK(s[:]) }

// 产期类型
type TThostFtdcProductDateType [41]byte

func (s TThostFtdcProductDateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProductDateType) GBString() string { return BytesToGBK(s[:]) }

// 等级类型
type TThostFtdcGradeType [41]byte

func (s TThostFtdcGradeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcGradeType) GBString() string { return BytesToGBK(s[:]) }

// 类别类型
type TThostFtdcClassifyType [41]byte

func (s TThostFtdcClassifyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClassifyType) GBString() string { return BytesToGBK(s[:]) }

// 货位类型
type TThostFtdcPositionType [41]byte

func (s TThostFtdcPositionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPositionType) GBString() string { return BytesToGBK(s[:]) }

// 产地类型
type TThostFtdcYieldlyType [41]byte

func (s TThostFtdcYieldlyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcYieldlyType) GBString() string { return BytesToGBK(s[:]) }

// 公定重量类型
type TThostFtdcWeightType [41]byte

func (s TThostFtdcWeightType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcWeightType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcFileNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFileNameType) GBString() string { return BytesToGBK(s[:]) }

// 上传文件类型类型
type TThostFtdcUploadModeType [21]byte

func (s TThostFtdcUploadModeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUploadModeType) GBString() string { return BytesToGBK(s[:]) }

// 投资者帐号类型
type TThostFtdcAccountIDType [13]byte

func (s TThostFtdcAccountIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAccountIDType) GBString() string { return BytesToGBK(s[:]) }

// 银行统一标识类型类型
type TThostFtdcBankFlagType [4]byte

func (s TThostFtdcBankFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankFlagType) GBString() string { return BytesToGBK(s[:]) }

// 银行账户类型
type TThostFtdcBankAccountType [41]byte

func (s TThostFtdcBankAccountType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankAccountType) GBString() string { return BytesToGBK(s[:]) }

// 银行账户的开户人名称类型
type TThostFtdcOpenNameType [61]byte

func (s TThostFtdcOpenNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOpenNameType) GBString() string { return BytesToGBK(s[:]) }

// 银行账户的开户行类型
type TThostFtdcOpenBankType [101]byte

func (s TThostFtdcOpenBankType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOpenBankType) GBString() string { return BytesToGBK(s[:]) }

// 银行名称类型
type TThostFtdcBankNameType [101]byte

func (s TThostFtdcBankNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankNameType) GBString() string { return BytesToGBK(s[:]) }

// 发布路径类型
type TThostFtdcPublishPathType [257]byte

func (s TThostFtdcPublishPathType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPublishPathType) GBString() string { return BytesToGBK(s[:]) }

// 操作员代码类型
type TThostFtdcOperatorIDType [65]byte

func (s TThostFtdcOperatorIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOperatorIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcAdvanceMonthArrayType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAdvanceMonthArrayType) GBString() string { return BytesToGBK(s[:]) }

// 日期表达式类型
type TThostFtdcDateExprType [1025]byte

func (s TThostFtdcDateExprType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDateExprType) GBString() string { return BytesToGBK(s[:]) }

// 合约代码表达式类型
type TThostFtdcInstrumentIDExprType [41]byte

func (s TThostFtdcInstrumentIDExprType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInstrumentIDExprType) GBString() string { return BytesToGBK(s[:]) }

// 合约名称表达式类型
type TThostFtdcInstrumentNameExprType [41]byte

func (s TThostFtdcInstrumentNameExprType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInstrumentNameExprType) GBString() string { return BytesToGBK(s[:]) }

// 日志级别类型
type TThostFtdcLogLevelType [33]byte

func (s TThostFtdcLogLevelType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLogLevelType) GBString() string { return BytesToGBK(s[:]) }

// 存储过程名称类型
type TThostFtdcProcessNameType [257]byte

func (s TThostFtdcProcessNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProcessNameType) GBString() string { return BytesToGBK(s[:]) }

// 操作摘要类型
type TThostFtdcOperationMemoType [1025]byte

func (s TThostFtdcOperationMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOperationMemoType) GBString() string { return BytesToGBK(s[:]) }

// 票据号类型
type TThostFtdcBillNoType [15]byte

func (s TThostFtdcBillNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBillNoType) GBString() string { return BytesToGBK(s[:]) }

// 票据名称类型
type TThostFtdcBillNameType [33]byte

func (s TThostFtdcBillNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBillNameType) GBString() string { return BytesToGBK(s[:]) }

// 枚举值代码类型
type TThostFtdcEnumValueIDType [65]byte

func (s TThostFtdcEnumValueIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcEnumValueIDType) GBString() string { return BytesToGBK(s[:]) }

// 枚举值类型类型
type TThostFtdcEnumValueTypeType [33]byte

func (s TThostFtdcEnumValueTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcEnumValueTypeType) GBString() string { return BytesToGBK(s[:]) }

// 枚举值名称类型
type TThostFtdcEnumValueLabelType [65]byte

func (s TThostFtdcEnumValueLabelType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcEnumValueLabelType) GBString() string { return BytesToGBK(s[:]) }

// 枚举值结果类型
type TThostFtdcEnumValueResultType [33]byte

func (s TThostFtdcEnumValueResultType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcEnumValueResultType) GBString() string { return BytesToGBK(s[:]) }

// 限定值类型类型
type TThostFtdcRangeIntTypeType [33]byte

func (s TThostFtdcRangeIntTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRangeIntTypeType) GBString() string { return BytesToGBK(s[:]) }

// 限定值下限类型
type TThostFtdcRangeIntFromType [33]byte

func (s TThostFtdcRangeIntFromType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRangeIntFromType) GBString() string { return BytesToGBK(s[:]) }

// 限定值上限类型
type TThostFtdcRangeIntToType [33]byte

func (s TThostFtdcRangeIntToType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRangeIntToType) GBString() string { return BytesToGBK(s[:]) }

// 功能代码类型
type TThostFtdcFunctionIDType [25]byte

func (s TThostFtdcFunctionIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFunctionIDType) GBString() string { return BytesToGBK(s[:]) }

// 功能编码类型
type TThostFtdcFunctionValueCodeType [257]byte

func (s TThostFtdcFunctionValueCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFunctionValueCodeType) GBString() string { return BytesToGBK(s[:]) }

// 功能名称类型
type TThostFtdcFunctionNameType [65]byte

func (s TThostFtdcFunctionNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFunctionNameType) GBString() string { return BytesToGBK(s[:]) }

// 角色编号类型
type TThostFtdcRoleIDType [11]byte

func (s TThostFtdcRoleIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRoleIDType) GBString() string { return BytesToGBK(s[:]) }

// 角色名称类型
type TThostFtdcRoleNameType [41]byte

func (s TThostFtdcRoleNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRoleNameType) GBString() string { return BytesToGBK(s[:]) }

// 描述类型
type TThostFtdcDescriptionType [401]byte

func (s TThostFtdcDescriptionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDescriptionType) GBString() string { return BytesToGBK(s[:]) }

// 组合编号类型
type TThostFtdcCombineIDType [25]byte

func (s TThostFtdcCombineIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCombineIDType) GBString() string { return BytesToGBK(s[:]) }

// 组合类型类型
type TThostFtdcCombineTypeType [25]byte

func (s TThostFtdcCombineTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCombineTypeType) GBString() string { return BytesToGBK(s[:]) }

// 盈亏算法说明类型
type TThostFtdcCommentType [31]byte

func (s TThostFtdcCommentType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCommentType) GBString() string { return BytesToGBK(s[:]) }

// 版本号类型
type TThostFtdcVersionType [4]byte

func (s TThostFtdcVersionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcVersionType) GBString() string { return BytesToGBK(s[:]) }

// 交易代码类型
type TThostFtdcTradeCodeType [7]byte

func (s TThostFtdcTradeCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTradeCodeType) GBString() string { return BytesToGBK(s[:]) }

// 交易日期类型
type TThostFtdcTradeDateType [9]byte

func (s TThostFtdcTradeDateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTradeDateType) GBString() string { return BytesToGBK(s[:]) }

// 交易时间类型
type TThostFtdcTradeTimeType [9]byte

func (s TThostFtdcTradeTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTradeTimeType) GBString() string { return BytesToGBK(s[:]) }

// 发起方流水号类型
type TThostFtdcTradeSerialType [9]byte

func (s TThostFtdcTradeSerialType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTradeSerialType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcFutureIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureIDType) GBString() string { return BytesToGBK(s[:]) }

// 银行代码类型
type TThostFtdcBankIDType [4]byte

func (s TThostFtdcBankIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankIDType) GBString() string { return BytesToGBK(s[:]) }

// 银行分中心代码类型
type TThostFtdcBankBrchIDType [5]byte

func (s TThostFtdcBankBrchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankBrchIDType) GBString() string { return BytesToGBK(s[:]) }

// 分中心代码类型
type TThostFtdcBankBranchIDType [11]byte

func (s TThostFtdcBankBranchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankBranchIDType) GBString() string { return BytesToGBK(s[:]) }

// 交易柜员类型
type TThostFtdcOperNoType [17]byte

func (s TThostFtdcOperNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOperNoType) GBString() string { return BytesToGBK(s[:]) }

// 渠道标志类型
type TThostFtdcDeviceIDType [3]byte

func (s TThostFtdcDeviceIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDeviceIDType) GBString() string { return BytesToGBK(s[:]) }

// 记录数类型
type TThostFtdcRecordNumType [7]byte

func (s TThostFtdcRecordNumType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRecordNumType) GBString() string { return BytesToGBK(s[:]) }

// 期货资金账号类型
type TThostFtdcFutureAccountType [22]byte

func (s TThostFtdcFutureAccountType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureAccountType) GBString() string { return BytesToGBK(s[:]) }

// 期货资金密码类型
type TThostFtdcFutureAccPwdType [17]byte

func (s TThostFtdcFutureAccPwdType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureAccPwdType) GBString() string { return BytesToGBK(s[:]) }

// 币种类型
type TThostFtdcCurrencyCodeType [4]byte

func (s TThostFtdcCurrencyCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCurrencyCodeType) GBString() string { return BytesToGBK(s[:]) }

// 响应代码类型
type TThostFtdcRetCodeType [5]byte

func (s TThostFtdcRetCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRetCodeType) GBString() string { return BytesToGBK(s[:]) }

// 响应信息类型
type TThostFtdcRetInfoType [129]byte

func (s TThostFtdcRetInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRetInfoType) GBString() string { return BytesToGBK(s[:]) }

// 银行总余额类型
type TThostFtdcTradeAmtType [20]byte

func (s TThostFtdcTradeAmtType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTradeAmtType) GBString() string { return BytesToGBK(s[:]) }

// 银行可用余额类型
type TThostFtdcUseAmtType [20]byte

func (s TThostFtdcUseAmtType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUseAmtType) GBString() string { return BytesToGBK(s[:]) }

// 银行可取余额类型
type TThostFtdcFetchAmtType [20]byte

func (s TThostFtdcFetchAmtType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFetchAmtType) GBString() string { return BytesToGBK(s[:]) }

// 证件号码类型
type TThostFtdcCertCodeType [21]byte

func (s TThostFtdcCertCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCertCodeType) GBString() string { return BytesToGBK(s[:]) }

// 资金项目编号类型
type TThostFtdcFundProjectIDType [5]byte

func (s TThostFtdcFundProjectIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFundProjectIDType) GBString() string { return BytesToGBK(s[:]) }

// 职业类型
type TThostFtdcProfessionType [101]byte

func (s TThostFtdcProfessionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProfessionType) GBString() string { return BytesToGBK(s[:]) }

// 国籍类型
type TThostFtdcNationalType [31]byte

func (s TThostFtdcNationalType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcNationalType) GBString() string { return BytesToGBK(s[:]) }

// 省类型
type TThostFtdcProvinceType [51]byte

func (s TThostFtdcProvinceType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProvinceType) GBString() string { return BytesToGBK(s[:]) }

// 区类型
type TThostFtdcRegionType [16]byte

func (s TThostFtdcRegionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRegionType) GBString() string { return BytesToGBK(s[:]) }

// 国家类型
type TThostFtdcCountryType [16]byte

func (s TThostFtdcCountryType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCountryType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCompanyTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCompanyTypeType) GBString() string { return BytesToGBK(s[:]) }

// 经营范围类型
type TThostFtdcBusinessScopeType [1001]byte

func (s TThostFtdcBusinessScopeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBusinessScopeType) GBString() string { return BytesToGBK(s[:]) }

// 注册资本币种类型
type TThostFtdcCapitalCurrencyType [4]byte

func (s TThostFtdcCapitalCurrencyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCapitalCurrencyType) GBString() string { return BytesToGBK(s[:]) }

// 营业部编号类型
type TThostFtdcBranchIDType [9]byte

func (s TThostFtdcBranchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBranchIDType) GBString() string { return BytesToGBK(s[:]) }

// 域名类型
type TThostFtdcBrokerDNSType [256]byte

func (s TThostFtdcBrokerDNSType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBrokerDNSType) GBString() string { return BytesToGBK(s[:]) }

// 语句类型
type TThostFtdcSentenceType [501]byte

func (s TThostFtdcSentenceType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSentenceType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcClearAccountType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClearAccountType) GBString() string { return BytesToGBK(s[:]) }

// 结算账户类型
type TThostFtdcOrganNOType [6]byte

func (s TThostFtdcOrganNOType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrganNOType) GBString() string { return BytesToGBK(s[:]) }

// 结算账户联行号类型
type TThostFtdcClearbarchIDType [6]byte

func (s TThostFtdcClearbarchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClearbarchIDType) GBString() string { return BytesToGBK(s[:]) }

// 用户事件信息类型
type TThostFtdcUserEventInfoType [1025]byte

func (s TThostFtdcUserEventInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUserEventInfoType) GBString() string { return BytesToGBK(s[:]) }

// 预埋报单编号类型
type TThostFtdcParkedOrderIDType [13]byte

func (s TThostFtdcParkedOrderIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcParkedOrderIDType) GBString() string { return BytesToGBK(s[:]) }

// 预埋撤单编号类型
type TThostFtdcParkedOrderActionIDType [13]byte

func (s TThostFtdcParkedOrderActionIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcParkedOrderActionIDType) GBString() string { return BytesToGBK(s[:]) }

// 影像类型名称类型
type TThostFtdcPhotoTypeNameType [41]byte

func (s TThostFtdcPhotoTypeNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPhotoTypeNameType) GBString() string { return BytesToGBK(s[:]) }

// 影像类型代码类型
type TThostFtdcPhotoTypeIDType [5]byte

func (s TThostFtdcPhotoTypeIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPhotoTypeIDType) GBString() string { return BytesToGBK(s[:]) }

// 影像名称类型
type TThostFtdcPhotoNameType [161]byte

func (s TThostFtdcPhotoNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPhotoNameType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcReportTypeIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcReportTypeIDType) GBString() string { return BytesToGBK(s[:]) }

// 交易特征代码类型
type TThostFtdcCharacterIDType [5]byte

func (s TThostFtdcCharacterIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCharacterIDType) GBString() string { return BytesToGBK(s[:]) }

// 参数代码类型
type TThostFtdcAMLParamIDType [21]byte

func (s TThostFtdcAMLParamIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLParamIDType) GBString() string { return BytesToGBK(s[:]) }

// 投资者类型类型
type TThostFtdcAMLInvestorTypeType [3]byte

func (s TThostFtdcAMLInvestorTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLInvestorTypeType) GBString() string { return BytesToGBK(s[:]) }

// 证件类型类型
type TThostFtdcAMLIdCardTypeType [3]byte

func (s TThostFtdcAMLIdCardTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLIdCardTypeType) GBString() string { return BytesToGBK(s[:]) }

// 资金进出方向类型
type TThostFtdcAMLTradeDirectType [3]byte

func (s TThostFtdcAMLTradeDirectType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLTradeDirectType) GBString() string { return BytesToGBK(s[:]) }

// 资金进出方式类型
type TThostFtdcAMLTradeModelType [3]byte

func (s TThostFtdcAMLTradeModelType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLTradeModelType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcAMLCustomerCardTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLCustomerCardTypeType) GBString() string { return BytesToGBK(s[:]) }

// 金融机构网点名称类型
type TThostFtdcAMLInstitutionNameType [65]byte

func (s TThostFtdcAMLInstitutionNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLInstitutionNameType) GBString() string { return BytesToGBK(s[:]) }

// 金融机构网点所在地区行政区划代码类型
type TThostFtdcAMLDistrictIDType [7]byte

func (s TThostFtdcAMLDistrictIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLDistrictIDType) GBString() string { return BytesToGBK(s[:]) }

// 金融机构网点与大额交易的关系类型
type TThostFtdcAMLRelationShipType [3]byte

func (s TThostFtdcAMLRelationShipType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLRelationShipType) GBString() string { return BytesToGBK(s[:]) }

// 金融机构网点代码类型类型
type TThostFtdcAMLInstitutionTypeType [3]byte

func (s TThostFtdcAMLInstitutionTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLInstitutionTypeType) GBString() string { return BytesToGBK(s[:]) }

// 金融机构网点代码类型
type TThostFtdcAMLInstitutionIDType [13]byte

func (s TThostFtdcAMLInstitutionIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLInstitutionIDType) GBString() string { return BytesToGBK(s[:]) }

// 账户类型类型
type TThostFtdcAMLAccountTypeType [5]byte

func (s TThostFtdcAMLAccountTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLAccountTypeType) GBString() string { return BytesToGBK(s[:]) }

// 交易方式类型
type TThostFtdcAMLTradingTypeType [7]byte

func (s TThostFtdcAMLTradingTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLTradingTypeType) GBString() string { return BytesToGBK(s[:]) }

// 涉外收支交易分类与代码类型
type TThostFtdcAMLTransactClassType [7]byte

func (s TThostFtdcAMLTransactClassType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLTransactClassType) GBString() string { return BytesToGBK(s[:]) }

// 资金收付标识类型
type TThostFtdcAMLCapitalIOType [3]byte

func (s TThostFtdcAMLCapitalIOType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLCapitalIOType) GBString() string { return BytesToGBK(s[:]) }

// 交易地点类型
type TThostFtdcAMLSiteType [10]byte

func (s TThostFtdcAMLSiteType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLSiteType) GBString() string { return BytesToGBK(s[:]) }

// 资金用途类型
type TThostFtdcAMLCapitalPurposeType [129]byte

func (s TThostFtdcAMLCapitalPurposeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLCapitalPurposeType) GBString() string { return BytesToGBK(s[:]) }

// 报文类型类型
type TThostFtdcAMLReportTypeType [2]byte

func (s TThostFtdcAMLReportTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLReportTypeType) GBString() string { return BytesToGBK(s[:]) }

// 编号类型
type TThostFtdcAMLSerialNoType [5]byte

func (s TThostFtdcAMLSerialNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLSerialNoType) GBString() string { return BytesToGBK(s[:]) }

// 状态类型
type TThostFtdcAMLStatusType [2]byte

func (s TThostFtdcAMLStatusType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLStatusType) GBString() string { return BytesToGBK(s[:]) }

// 业务标识号类型
type TThostFtdcAMLSeqCodeType [65]byte

func (s TThostFtdcAMLSeqCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLSeqCodeType) GBString() string { return BytesToGBK(s[:]) }

// AML文件名类型
type TThostFtdcAMLFileNameType [257]byte

func (s TThostFtdcAMLFileNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLFileNameType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCFMMCKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCFMMCKeyType) GBString() string { return BytesToGBK(s[:]) }

// 令牌类型(保证金监管)类型
type TThostFtdcCFMMCTokenType [21]byte

func (s TThostFtdcCFMMCTokenType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCFMMCTokenType) GBString() string { return BytesToGBK(s[:]) }

// 报文名称类型
type TThostFtdcAMLReportNameType [81]byte

func (s TThostFtdcAMLReportNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAMLReportNameType) GBString() string { return BytesToGBK(s[:]) }

// 个人姓名类型
type TThostFtdcIndividualNameType [51]byte

func (s TThostFtdcIndividualNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIndividualNameType) GBString() string { return BytesToGBK(s[:]) }

// 币种代码类型
type TThostFtdcCurrencyIDType [4]byte

func (s TThostFtdcCurrencyIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCurrencyIDType) GBString() string { return BytesToGBK(s[:]) }

// 客户编号类型
type TThostFtdcCustNumberType [36]byte

func (s TThostFtdcCustNumberType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCustNumberType) GBString() string { return BytesToGBK(s[:]) }

// 机构编码类型
type TThostFtdcOrganCodeType [36]byte

func (s TThostFtdcOrganCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrganCodeType) GBString() string { return BytesToGBK(s[:]) }

// 机构名称类型
type TThostFtdcOrganNameType [71]byte

func (s TThostFtdcOrganNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrganNameType) GBString() string { return BytesToGBK(s[:]) }

// 上级机构编码,即期货公司总部、银行总行类型
type TThostFtdcSuperOrganCodeType [12]byte

func (s TThostFtdcSuperOrganCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSuperOrganCodeType) GBString() string { return BytesToGBK(s[:]) }

// 分支机构类型
type TThostFtdcSubBranchIDType [31]byte

func (s TThostFtdcSubBranchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSubBranchIDType) GBString() string { return BytesToGBK(s[:]) }

// 分支机构名称类型
type TThostFtdcSubBranchNameType [71]byte

func (s TThostFtdcSubBranchNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSubBranchNameType) GBString() string { return BytesToGBK(s[:]) }

// 机构网点号类型
type TThostFtdcBranchNetCodeType [31]byte

func (s TThostFtdcBranchNetCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBranchNetCodeType) GBString() string { return BytesToGBK(s[:]) }

// 机构网点名称类型
type TThostFtdcBranchNetNameType [71]byte

func (s TThostFtdcBranchNetNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBranchNetNameType) GBString() string { return BytesToGBK(s[:]) }

// 机构标识类型
type TThostFtdcOrganFlagType [2]byte

func (s TThostFtdcOrganFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOrganFlagType) GBString() string { return BytesToGBK(s[:]) }

// 银行对期货公司的编码类型
type TThostFtdcBankCodingForFutureType [33]byte

func (s TThostFtdcBankCodingForFutureType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankCodingForFutureType) GBString() string { return BytesToGBK(s[:]) }

// 银行对返回码的定义类型
type TThostFtdcBankReturnCodeType [7]byte

func (s TThostFtdcBankReturnCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankReturnCodeType) GBString() string { return BytesToGBK(s[:]) }

// 银期转帐平台对返回码的定义类型
type TThostFtdcPlateReturnCodeType [5]byte

func (s TThostFtdcPlateReturnCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPlateReturnCodeType) GBString() string { return BytesToGBK(s[:]) }

// 银行分支机构编码类型
type TThostFtdcBankSubBranchIDType [31]byte

func (s TThostFtdcBankSubBranchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankSubBranchIDType) GBString() string { return BytesToGBK(s[:]) }

// 期货分支机构编码类型
type TThostFtdcFutureBranchIDType [31]byte

func (s TThostFtdcFutureBranchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureBranchIDType) GBString() string { return BytesToGBK(s[:]) }

// 返回代码类型
type TThostFtdcReturnCodeType [7]byte

func (s TThostFtdcReturnCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcReturnCodeType) GBString() string { return BytesToGBK(s[:]) }

// 操作员类型
type TThostFtdcOperatorCodeType [17]byte

func (s TThostFtdcOperatorCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOperatorCodeType) GBString() string { return BytesToGBK(s[:]) }

// 机构结算帐户机构号类型
type TThostFtdcClearDepIDType [6]byte

func (s TThostFtdcClearDepIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClearDepIDType) GBString() string { return BytesToGBK(s[:]) }

// 机构结算帐户联行号类型
type TThostFtdcClearBrchIDType [6]byte

func (s TThostFtdcClearBrchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClearBrchIDType) GBString() string { return BytesToGBK(s[:]) }

// 机构结算帐户名称类型
type TThostFtdcClearNameType [71]byte

func (s TThostFtdcClearNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClearNameType) GBString() string { return BytesToGBK(s[:]) }

// 银行帐户名称类型
type TThostFtdcBankAccountNameType [71]byte

func (s TThostFtdcBankAccountNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankAccountNameType) GBString() string { return BytesToGBK(s[:]) }

// 机构投资人账号机构号类型
type TThostFtdcInvDepIDType [6]byte

func (s TThostFtdcInvDepIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvDepIDType) GBString() string { return BytesToGBK(s[:]) }

// 机构投资人联行号类型
type TThostFtdcInvBrchIDType [6]byte

func (s TThostFtdcInvBrchIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvBrchIDType) GBString() string { return BytesToGBK(s[:]) }

// 信息格式版本类型
type TThostFtdcMessageFormatVersionType [36]byte

func (s TThostFtdcMessageFormatVersionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcMessageFormatVersionType) GBString() string { return BytesToGBK(s[:]) }

// 摘要类型
type TThostFtdcDigestType [36]byte

func (s TThostFtdcDigestType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDigestType) GBString() string { return BytesToGBK(s[:]) }

// 认证数据类型
type TThostFtdcAuthenticDataType [129]byte

func (s TThostFtdcAuthenticDataType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAuthenticDataType) GBString() string { return BytesToGBK(s[:]) }

// 密钥类型
type TThostFtdcPasswordKeyType [129]byte

func (s TThostFtdcPasswordKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPasswordKeyType) GBString() string { return BytesToGBK(s[:]) }

// 期货帐户名称类型
type TThostFtdcFutureAccountNameType [129]byte

func (s TThostFtdcFutureAccountNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureAccountNameType) GBString() string { return BytesToGBK(s[:]) }

// 手机类型
type TThostFtdcMobilePhoneType [21]byte

func (s TThostFtdcMobilePhoneType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcMobilePhoneType) GBString() string { return BytesToGBK(s[:]) }

// 期货公司主密钥类型
type TThostFtdcFutureMainKeyType [129]byte

func (s TThostFtdcFutureMainKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureMainKeyType) GBString() string { return BytesToGBK(s[:]) }

// 期货公司工作密钥类型
type TThostFtdcFutureWorkKeyType [129]byte

func (s TThostFtdcFutureWorkKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureWorkKeyType) GBString() string { return BytesToGBK(s[:]) }

// 期货公司传输密钥类型
type TThostFtdcFutureTransKeyType [129]byte

func (s TThostFtdcFutureTransKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFutureTransKeyType) GBString() string { return BytesToGBK(s[:]) }

// 银行主密钥类型
type TThostFtdcBankMainKeyType [129]byte

func (s TThostFtdcBankMainKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankMainKeyType) GBString() string { return BytesToGBK(s[:]) }

// 银行工作密钥类型
type TThostFtdcBankWorkKeyType [129]byte

func (s TThostFtdcBankWorkKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankWorkKeyType) GBString() string { return BytesToGBK(s[:]) }

// 银行传输密钥类型
type TThostFtdcBankTransKeyType [129]byte

func (s TThostFtdcBankTransKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankTransKeyType) GBString() string { return BytesToGBK(s[:]) }

// 银行服务器描述信息类型
type TThostFtdcBankServerDescriptionType [129]byte

func (s TThostFtdcBankServerDescriptionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankServerDescriptionType) GBString() string { return BytesToGBK(s[:]) }

// 附加信息类型
type TThostFtdcAddInfoType [129]byte

func (s TThostFtdcAddInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAddInfoType) GBString() string { return BytesToGBK(s[:]) }

// 返回码描述类型
type TThostFtdcDescrInfoForReturnCodeType [129]byte

func (s TThostFtdcDescrInfoForReturnCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDescrInfoForReturnCodeType) GBString() string { return BytesToGBK(s[:]) }

// 国家代码类型
type TThostFtdcCountryCodeType [21]byte

func (s TThostFtdcCountryCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCountryCodeType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcBankSerialType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankSerialType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcServiceNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcServiceNameType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcBankIDByBankType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankIDByBankType) GBString() string { return BytesToGBK(s[:]) }

// 银行操作员号类型
type TThostFtdcBankOperNoType [4]byte

func (s TThostFtdcBankOperNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankOperNoType) GBString() string { return BytesToGBK(s[:]) }

// 银行客户号类型
type TThostFtdcBankCustNoType [21]byte

func (s TThostFtdcBankCustNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankCustNoType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcTableNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTableNameType) GBString() string { return BytesToGBK(s[:]) }

// FBT表操作主键名类型
type TThostFtdcPKNameType [201]byte

func (s TThostFtdcPKNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPKNameType) GBString() string { return BytesToGBK(s[:]) }

// FBT表操作主键值类型
type TThostFtdcPKValueType [501]byte

func (s TThostFtdcPKValueType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPKValueType) GBString() string { return BytesToGBK(s[:]) }

// 同步目标编号类型
type TThostFtdcTargetIDType [4]byte

func (s TThostFtdcTargetIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTargetIDType) GBString() string { return BytesToGBK(s[:]) }

// 各种换汇时间类型
type TThostFtdcFBETimeType [7]byte

func (s TThostFtdcFBETimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBETimeType) GBString() string { return BytesToGBK(s[:]) }

// 换汇银行行号类型
type TThostFtdcFBEBankNoType [13]byte

func (s TThostFtdcFBEBankNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEBankNoType) GBString() string { return BytesToGBK(s[:]) }

// 换汇凭证号类型
type TThostFtdcFBECertNoType [13]byte

func (s TThostFtdcFBECertNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBECertNoType) GBString() string { return BytesToGBK(s[:]) }

// 换汇银行账户类型
type TThostFtdcFBEBankAccountType [33]byte

func (s TThostFtdcFBEBankAccountType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEBankAccountType) GBString() string { return BytesToGBK(s[:]) }

// 换汇银行账户名类型
type TThostFtdcFBEBankAccountNameType [61]byte

func (s TThostFtdcFBEBankAccountNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEBankAccountNameType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcFBEBusinessTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEBusinessTypeType) GBString() string { return BytesToGBK(s[:]) }

// 换汇附言类型
type TThostFtdcFBEPostScriptType [61]byte

func (s TThostFtdcFBEPostScriptType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEPostScriptType) GBString() string { return BytesToGBK(s[:]) }

// 换汇备注类型
type TThostFtdcFBERemarkType [71]byte

func (s TThostFtdcFBERemarkType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBERemarkType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcFBERtnMsgType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBERtnMsgType) GBString() string { return BytesToGBK(s[:]) }

// 换汇扩展信息类型
type TThostFtdcFBEExtendMsgType [61]byte

func (s TThostFtdcFBEExtendMsgType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEExtendMsgType) GBString() string { return BytesToGBK(s[:]) }

// 换汇记账流水号类型
type TThostFtdcFBEBusinessSerialType [31]byte

func (s TThostFtdcFBEBusinessSerialType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEBusinessSerialType) GBString() string { return BytesToGBK(s[:]) }

// 换汇流水号类型
type TThostFtdcFBESystemSerialType [21]byte

func (s TThostFtdcFBESystemSerialType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBESystemSerialType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcFBEOpenBankType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEOpenBankType) GBString() string { return BytesToGBK(s[:]) }

// 换汇相关文件名类型
type TThostFtdcFBEFileNameType [21]byte

func (s TThostFtdcFBEFileNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEFileNameType) GBString() string { return BytesToGBK(s[:]) }

// 换汇批次号类型
type TThostFtdcFBEBatchSerialType [21]byte

func (s TThostFtdcFBEBatchSerialType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFBEBatchSerialType) GBString() string { return BytesToGBK(s[:]) }

// 客户风险通知消息类型
type TThostFtdcRiskNofityInfoType [257]byte

func (s TThostFtdcRiskNofityInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRiskNofityInfoType) GBString() string { return BytesToGBK(s[:]) }

// 强平场景编号类型
type TThostFtdcForceCloseSceneIdType [24]byte

func (s TThostFtdcForceCloseSceneIdType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcForceCloseSceneIdType) GBString() string { return BytesToGBK(s[:]) }

// 多个产品代码,用+分隔,如cu+zn类型
type TThostFtdcInstrumentIDsType [101]byte

func (s TThostFtdcInstrumentIDsType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInstrumentIDsType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcParamNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcParamNameType) GBString() string { return BytesToGBK(s[:]) }

// 参数值类型
type TThostFtdcParamValueType [41]byte

func (s TThostFtdcParamValueType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcParamValueType) GBString() string { return BytesToGBK(s[:]) }

// 行业编码类型
type TThostFtdcIndustryIDType [17]byte

func (s TThostFtdcIndustryIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIndustryIDType) GBString() string { return BytesToGBK(s[:]) }

// 特有信息编号类型
type TThostFtdcQuestionIDType [5]byte

func (s TThostFtdcQuestionIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcQuestionIDType) GBString() string { return BytesToGBK(s[:]) }

// 特有信息说明类型
type TThostFtdcQuestionContentType [41]byte

func (s TThostFtdcQuestionContentType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcQuestionContentType) GBString() string { return BytesToGBK(s[:]) }

// 选项编号类型
type TThostFtdcOptionIDType [13]byte

func (s TThostFtdcOptionIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOptionIDType) GBString() string { return BytesToGBK(s[:]) }

// 选项说明类型
type TThostFtdcOptionContentType [61]byte

func (s TThostFtdcOptionContentType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOptionContentType) GBString() string { return BytesToGBK(s[:]) }

// 业务流水号类型
type TThostFtdcProcessIDType [33]byte

func (s TThostFtdcProcessIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProcessIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcUOAProcessStatusType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOAProcessStatusType) GBString() string { return BytesToGBK(s[:]) }

// 流程功能类型类型
type TThostFtdcProcessTypeType [3]byte

func (s TThostFtdcProcessTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcProcessTypeType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcClientClassifyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClientClassifyType) GBString() string { return BytesToGBK(s[:]) }

// 单位性质类型
type TThostFtdcUOAOrganTypeType [11]byte

func (s TThostFtdcUOAOrganTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOAOrganTypeType) GBString() string { return BytesToGBK(s[:]) }

// 国家代码类型
type TThostFtdcUOACountryCodeType [11]byte

func (s TThostFtdcUOACountryCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOACountryCodeType) GBString() string { return BytesToGBK(s[:]) }

// 区号类型
type TThostFtdcAreaCodeType [11]byte

func (s TThostFtdcAreaCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAreaCodeType) GBString() string { return BytesToGBK(s[:]) }

// 监控中心为客户分配的代码类型
type TThostFtdcFuturesIDType [21]byte

func (s TThostFtdcFuturesIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFuturesIDType) GBString() string { return BytesToGBK(s[:]) }

// 日期类型
type TThostFtdcCffmcDateType [11]byte

func (s TThostFtdcCffmcDateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCffmcDateType) GBString() string { return BytesToGBK(s[:]) }

// 时间类型
type TThostFtdcCffmcTimeType [11]byte

func (s TThostFtdcCffmcTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCffmcTimeType) GBString() string { return BytesToGBK(s[:]) }

// 组织机构代码类型
type TThostFtdcNocIDType [21]byte

func (s TThostFtdcNocIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcNocIDType) GBString() string { return BytesToGBK(s[:]) }

// 业务操作类型类型
type TThostFtdcEventTypeType [33]byte

func (s TThostFtdcEventTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcEventTypeType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcRateTemplateNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRateTemplateNameType) GBString() string { return BytesToGBK(s[:]) }

// 用于查询的投资属性字段类型
type TThostFtdcPropertyStringType [2049]byte

func (s TThostFtdcPropertyStringType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPropertyStringType) GBString() string { return BytesToGBK(s[:]) }

// 模型代码类型
type TThostFtdcRateTemplateIDType [9]byte

func (s TThostFtdcRateTemplateIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRateTemplateIDType) GBString() string { return BytesToGBK(s[:]) }

// 风险度类型
type TThostFtdcRiskRateType [21]byte

func (s TThostFtdcRiskRateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRiskRateType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcInvestorIDRuleNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestorIDRuleNameType) GBString() string { return BytesToGBK(s[:]) }

// 号段规则表达式类型
type TThostFtdcInvestorIDRuleExprType [513]byte

func (s TThostFtdcInvestorIDRuleExprType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestorIDRuleExprType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcAuthKeyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAuthKeyType) GBString() string { return BytesToGBK(s[:]) }

// 序列号类型
type TThostFtdcSerialNumberType [17]byte

func (s TThostFtdcSerialNumberType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSerialNumberType) GBString() string { return BytesToGBK(s[:]) }

// 动态令牌提供商类型
type TThostFtdcOTPVendorsIDType [2]byte

func (s TThostFtdcOTPVendorsIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOTPVendorsIDType) GBString() string { return BytesToGBK(s[:]) }

// 动态令牌提供商名称类型
type TThostFtdcOTPVendorsNameType [61]byte

func (s TThostFtdcOTPVendorsNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOTPVendorsNameType) GBString() string { return BytesToGBK(s[:]) }

// 时间跨度类型
type TThostFtdcTimeSpanType [9]byte

func (s TThostFtdcTimeSpanType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcTimeSpanType) GBString() string { return BytesToGBK(s[:]) }

// 动态令牌导入批次编号类型
type TThostFtdcImportSequenceIDType [17]byte

func (s TThostFtdcImportSequenceIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcImportSequenceIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcUserProductIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUserProductIDType) GBString() string { return BytesToGBK(s[:]) }

// 产品名称类型
type TThostFtdcUserProductNameType [65]byte

func (s TThostFtdcUserProductNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUserProductNameType) GBString() string { return BytesToGBK(s[:]) }

// 产品说明类型
type TThostFtdcUserProductMemoType [129]byte

func (s TThostFtdcUserProductMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUserProductMemoType) GBString() string { return BytesToGBK(s[:]) }

// 新增或变更标志类型
type TThostFtdcCSRCCancelFlagType [2]byte

func (s TThostFtdcCSRCCancelFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCCancelFlagType) GBString() string { return BytesToGBK(s[:]) }

// 日期类型
type TThostFtdcCSRCDateType [11]byte

func (s TThostFtdcCSRCDateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCDateType) GBString() string { return BytesToGBK(s[:]) }

// 客户名称类型
type TThostFtdcCSRCInvestorNameType [201]byte

func (s TThostFtdcCSRCInvestorNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCInvestorNameType) GBString() string { return BytesToGBK(s[:]) }

// 客户名称类型
type TThostFtdcCSRCOpenInvestorNameType [101]byte

func (s TThostFtdcCSRCOpenInvestorNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCOpenInvestorNameType) GBString() string { return BytesToGBK(s[:]) }

// 客户代码类型
type TThostFtdcCSRCInvestorIDType [13]byte

func (s TThostFtdcCSRCInvestorIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCInvestorIDType) GBString() string { return BytesToGBK(s[:]) }

// 证件号码类型
type TThostFtdcCSRCIdentifiedCardNoType [51]byte

func (s TThostFtdcCSRCIdentifiedCardNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCIdentifiedCardNoType) GBString() string { return BytesToGBK(s[:]) }

// 交易编码类型
type TThostFtdcCSRCClientIDType [11]byte

func (s TThostFtdcCSRCClientIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCClientIDType) GBString() string { return BytesToGBK(s[:]) }

// 银行标识类型
type TThostFtdcCSRCBankFlagType [3]byte

func (s TThostFtdcCSRCBankFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCBankFlagType) GBString() string { return BytesToGBK(s[:]) }

// 银行账户类型
type TThostFtdcCSRCBankAccountType [23]byte

func (s TThostFtdcCSRCBankAccountType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCBankAccountType) GBString() string { return BytesToGBK(s[:]) }

// 开户人类型
type TThostFtdcCSRCOpenNameType [401]byte

func (s TThostFtdcCSRCOpenNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCOpenNameType) GBString() string { return BytesToGBK(s[:]) }

// 说明类型
type TThostFtdcCSRCMemoType [101]byte

func (s TThostFtdcCSRCMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCMemoType) GBString() string { return BytesToGBK(s[:]) }

// 时间类型
type TThostFtdcCSRCTimeType [11]byte

func (s TThostFtdcCSRCTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCTimeType) GBString() string { return BytesToGBK(s[:]) }

// 成交流水号类型
type TThostFtdcCSRCTradeIDType [21]byte

func (s TThostFtdcCSRCTradeIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCTradeIDType) GBString() string { return BytesToGBK(s[:]) }

// 合约代码类型
type TThostFtdcCSRCExchangeInstIDType [31]byte

func (s TThostFtdcCSRCExchangeInstIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCExchangeInstIDType) GBString() string { return BytesToGBK(s[:]) }

// 质押品名称类型
type TThostFtdcCSRCMortgageNameType [7]byte

func (s TThostFtdcCSRCMortgageNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCMortgageNameType) GBString() string { return BytesToGBK(s[:]) }

// 事由类型
type TThostFtdcCSRCReasonType [3]byte

func (s TThostFtdcCSRCReasonType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCReasonType) GBString() string { return BytesToGBK(s[:]) }

// 是否为非结算会员类型
type TThostFtdcIsSettlementType [2]byte

func (s TThostFtdcIsSettlementType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIsSettlementType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCSRCOptionsTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCOptionsTypeType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCSRCTargetProductIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCTargetProductIDType) GBString() string { return BytesToGBK(s[:]) }

// 标的合约类型
type TThostFtdcCSRCTargetInstrIDType [31]byte

func (s TThostFtdcCSRCTargetInstrIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCTargetInstrIDType) GBString() string { return BytesToGBK(s[:]) }

// 手续费率模板名称类型
type TThostFtdcCommModelNameType [161]byte

func (s TThostFtdcCommModelNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCommModelNameType) GBString() string { return BytesToGBK(s[:]) }

// 手续费率模板备注类型
type TThostFtdcCommModelMemoType [1025]byte

func (s TThostFtdcCommModelMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCommModelMemoType) GBString() string { return BytesToGBK(s[:]) }

// 代理经纪公司代码类型
type TThostFtdcAgentBrokerIDType [13]byte

func (s TThostFtdcAgentBrokerIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAgentBrokerIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcDRIdentityNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDRIdentityNameType) GBString() string { return BytesToGBK(s[:]) }

// DBLink标识号类型
type TThostFtdcDBLinkIDType [31]byte

func (s TThostFtdcDBLinkIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDBLinkIDType) GBString() string { return BytesToGBK(s[:]) }

// 风险度类型
type TThostFtdcSRiskRateType [21]byte

func (s TThostFtdcSRiskRateType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSRiskRateType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCSRCFreezeStatusType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCFreezeStatusType) GBString() string { return BytesToGBK(s[:]) }

// 模板代码类型
type TThostFtdcRightTemplateIDType [9]byte

func (s TThostFtdcRightTemplateIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRightTemplateIDType) GBString() string { return BytesToGBK(s[:]) }

// 模板名称类型
type TThostFtdcRightTemplateNameType [61]byte

func (s TThostFtdcRightTemplateNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRightTemplateNameType) GBString() string { return BytesToGBK(s[:]) }

// 反洗钱数据抽取审核流程类型
type TThostFtdcAmlCheckFlowType [2]byte

func (s TThostFtdcAmlCheckFlowType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAmlCheckFlowType) GBString() string { return BytesToGBK(s[:]) }

// 数据类型类型
type TThostFtdcDataTypeType [129]byte

func (s TThostFtdcDataTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDataTypeType) GBString() string { return BytesToGBK(s[:]) }

// 结算配置代码类型
type TThostFtdcSettleManagerIDType [33]byte

func (s TThostFtdcSettleManagerIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSettleManagerIDType) GBString() string { return BytesToGBK(s[:]) }

// 结算配置名称类型
type TThostFtdcSettleManagerNameType [129]byte

func (s TThostFtdcSettleManagerNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSettleManagerNameType) GBString() string { return BytesToGBK(s[:]) }

// 核对结果说明类型
type TThostFtdcCheckResultMemoType [1025]byte

func (s TThostFtdcCheckResultMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCheckResultMemoType) GBString() string { return BytesToGBK(s[:]) }

// 功能链接类型
type TThostFtdcFunctionUrlType [1025]byte

func (s TThostFtdcFunctionUrlType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcFunctionUrlType) GBString() string { return BytesToGBK(s[:]) }

// 客户端认证信息类型
type TThostFtdcAuthInfoType [129]byte

func (s TThostFtdcAuthInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAuthInfoType) GBString() string { return BytesToGBK(s[:]) }

// 客户端认证码类型
type TThostFtdcAuthCodeType [17]byte

func (s TThostFtdcAuthCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAuthCodeType) GBString() string { return BytesToGBK(s[:]) }

// 工具代码类型
type TThostFtdcToolIDType [9]byte

func (s TThostFtdcToolIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcToolIDType) GBString() string { return BytesToGBK(s[:]) }

// 工具名称类型
type TThostFtdcToolNameType [81]byte

func (s TThostFtdcToolNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcToolNameType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCurrencyNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCurrencyNameType) GBString() string { return BytesToGBK(s[:]) }

// 币种符号类型
type TThostFtdcCurrencySignType [4]byte

func (s TThostFtdcCurrencySignType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCurrencySignType) GBString() string { return BytesToGBK(s[:]) }

// 凭证号类型
type TThostFtdcCurrExchCertNoType [13]byte

func (s TThostFtdcCurrExchCertNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCurrExchCertNoType) GBString() string { return BytesToGBK(s[:]) }

// 批次号类型
type TThostFtdcBatchSerialNoType [21]byte

func (s TThostFtdcBatchSerialNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBatchSerialNoType) GBString() string { return BytesToGBK(s[:]) }

// 换汇页面控制类型
type TThostFtdcPageControlType [2]byte

func (s TThostFtdcPageControlType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPageControlType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCurrencySwapMemoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCurrencySwapMemoType) GBString() string { return BytesToGBK(s[:]) }

// 工作单位类型
type TThostFtdcWorkPlaceType [101]byte

func (s TThostFtdcWorkPlaceType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcWorkPlaceType) GBString() string { return BytesToGBK(s[:]) }

// 经营期限类型
type TThostFtdcBusinessPeriodType [21]byte

func (s TThostFtdcBusinessPeriodType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBusinessPeriodType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcUOAIdCardTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOAIdCardTypeType) GBString() string { return BytesToGBK(s[:]) }

// 开户模式类型
type TThostFtdcClientModeType [3]byte

func (s TThostFtdcClientModeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClientModeType) GBString() string { return BytesToGBK(s[:]) }

// 投资者全称类型
type TThostFtdcInvestorFullNameType [101]byte

func (s TThostFtdcInvestorFullNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestorFullNameType) GBString() string { return BytesToGBK(s[:]) }

// 境外中介机构ID类型
type TThostFtdcUOABrokerIDType [11]byte

func (s TThostFtdcUOABrokerIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOABrokerIDType) GBString() string { return BytesToGBK(s[:]) }

// 邮政编码类型
type TThostFtdcUOAZipCodeType [11]byte

func (s TThostFtdcUOAZipCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOAZipCodeType) GBString() string { return BytesToGBK(s[:]) }

// 电子邮箱类型
type TThostFtdcUOAEMailType [101]byte

func (s TThostFtdcUOAEMailType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOAEMailType) GBString() string { return BytesToGBK(s[:]) }

// 城市类型
type TThostFtdcOldCityType [41]byte

func (s TThostFtdcOldCityType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOldCityType) GBString() string { return BytesToGBK(s[:]) }

// 法人代表证件号码类型
type TThostFtdcCorporateIdentifiedCardNoType [101]byte

func (s TThostFtdcCorporateIdentifiedCardNoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCorporateIdentifiedCardNoType) GBString() string { return BytesToGBK(s[:]) }

// 分户管理资产编码类型
type TThostFtdcLedgerManageIDType [51]byte

func (s TThostFtdcLedgerManageIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLedgerManageIDType) GBString() string { return BytesToGBK(s[:]) }

// 投资品种类型
type TThostFtdcInvestVarietyType [101]byte

func (s TThostFtdcInvestVarietyType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestVarietyType) GBString() string { return BytesToGBK(s[:]) }

// 账户类别类型
type TThostFtdcBankAccountTypeType [2]byte

func (s TThostFtdcBankAccountTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBankAccountTypeType) GBString() string { return BytesToGBK(s[:]) }

// 开户银行类型
type TThostFtdcLedgerManageBankType [101]byte

func (s TThostFtdcLedgerManageBankType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLedgerManageBankType) GBString() string { return BytesToGBK(s[:]) }

// 开户营业部类型
type TThostFtdcCffexDepartmentNameType [101]byte

func (s TThostFtdcCffexDepartmentNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCffexDepartmentNameType) GBString() string { return BytesToGBK(s[:]) }

// 营业部代码类型
type TThostFtdcCffexDepartmentCodeType [9]byte

func (s TThostFtdcCffexDepartmentCodeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCffexDepartmentCodeType) GBString() string { return BytesToGBK(s[:]) }

// 说明类型
type TThostFtdcCSRCMemo1Type [41]byte

func (s TThostFtdcCSRCMemo1Type) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCMemo1Type) GBString() string { return BytesToGBK(s[:]) }

// 代理资产管理业务的期货公司全称类型
type TThostFtdcAssetmgrCFullNameType [101]byte

func (s TThostFtdcAssetmgrCFullNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAssetmgrCFullNameType) GBString() string { return BytesToGBK(s[:]) }

// 资产管理业务批文号类型
type TThostFtdcAssetmgrApprovalNOType [51]byte

func (s TThostFtdcAssetmgrApprovalNOType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAssetmgrApprovalNOType) GBString() string { return BytesToGBK(s[:]) }

// 资产管理业务负责人姓名类型
type TThostFtdcAssetmgrMgrNameType [401]byte

func (s TThostFtdcAssetmgrMgrNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAssetmgrMgrNameType) GBString() string { return BytesToGBK(s[:]) }

// 机构类型类型
type TThostFtdcCSRCAmTypeType [5]byte

func (s TThostFtdcCSRCAmTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCAmTypeType) GBString() string { return BytesToGBK(s[:]) }

// 国籍类型
type TThostFtdcCSRCNationalType [4]byte

func (s TThostFtdcCSRCNationalType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCNationalType) GBString() string { return BytesToGBK(s[:]) }

// 二级代理ID类型
type TThostFtdcCSRCSecAgentIDType [11]byte

func (s TThostFtdcCSRCSecAgentIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCSRCSecAgentIDType) GBString() string { return BytesToGBK(s[:]) }

// 投资账户类型
type TThostFtdcAmAccountType [23]byte

func (s TThostFtdcAmAccountType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAmAccountType) GBString() string { return BytesToGBK(s[:]) }

// 计量单位类型
type TThostFtdcUOMType [11]byte

func (s TThostFtdcUOMType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcUOMType) GBString() string { return BytesToGBK(s[:]) }

// 上期所合约生命周期状态类型
type TThostFtdcSHFEInstLifePhaseType [3]byte

func (s TThostFtdcSHFEInstLifePhaseType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSHFEInstLifePhaseType) GBString() string { return BytesToGBK(s[:]) }

// 产品类型类型
type TThostFtdcSHFEProductClassType [11]byte

func (s TThostFtdcSHFEProductClassType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSHFEProductClassType) GBString() string { return BytesToGBK(s[:]) }

// 价格小数位类型
type TThostFtdcPriceDecimalType [2]byte

func (s TThostFtdcPriceDecimalType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcPriceDecimalType) GBString() string { return BytesToGBK(s[:]) }

// 平值期权标志类型
type TThostFtdcInTheMoneyFlagType [2]byte

func (s TThostFtdcInTheMoneyFlagType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInTheMoneyFlagType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCombinInstrIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCombinInstrIDType) GBString() string { return BytesToGBK(s[:]) }

// 各腿结算价类型
type TThostFtdcCombinSettlePriceType [61]byte

func (s TThostFtdcCombinSettlePriceType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCombinSettlePriceType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcSwapBusinessTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSwapBusinessTypeType) GBString() string { return BytesToGBK(s[:]) }

// 执行宣告系统编号类型
type TThostFtdcExecOrderSysIDType [21]byte

func (s TThostFtdcExecOrderSysIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcExecOrderSysIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcStrikeTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcStrikeTimeType) GBString() string { return BytesToGBK(s[:]) }

// 登录备注类型
type TThostFtdcLoginRemarkType [36]byte

func (s TThostFtdcLoginRemarkType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLoginRemarkType) GBString() string { return BytesToGBK(s[:]) }

// 投资单元代码类型
type TThostFtdcInvestUnitIDType [17]byte

func (s TThostFtdcInvestUnitIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcInvestUnitIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcNewsTypeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcNewsTypeType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcAbstractType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAbstractType) GBString() string { return BytesToGBK(s[:]) }

// 消息来源类型
type TThostFtdcComeFromType [21]byte

func (s TThostFtdcComeFromType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcComeFromType) GBString() string { return BytesToGBK(s[:]) }

// WEB地址类型
type TThostFtdcURLLinkType [201]byte

func (s TThostFtdcURLLinkType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcURLLinkType) GBString() string { return BytesToGBK(s[:]) }

// 长个人姓名类型
type TThostFtdcLongIndividualNameType [161]byte

func (s TThostFtdcLongIndividualNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLongIndividualNameType) GBString() string { return BytesToGBK(s[:]) }

// 长换汇银行账户名类型
type TThostFtdcLongFBEBankAccountNameType [161]byte

func (s TThostFtdcLongFBEBankAccountNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcLongFBEBankAccountNameType) GBString() string { return BytesToGBK(s[:]) }

// 日期时间类型
type TThostFtdcDateTimeType [17]byte

func (s TThostFtdcDateTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcDateTimeType) GBString() string { return BytesToGBK(s[:]) }

// 随机串类型
type TThostFtdcRandomStringType [17]byte

func (s TThostFtdcRandomStringType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcRandomStringType) GBString() string { return BytesToGBK(s[:]) }

// App代码类型
type TThostFtdcAppIDType [33]byte

func (s TThostFtdcAppIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAppIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcClientSystemInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcClientSystemInfoType) GBString() string { return BytesToGBK(s[:]) }

// 系统外部信息类型
type TThostFtdcAdditionalInfoType [261]byte

func (s TThostFtdcAdditionalInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcAdditionalInfoType) GBString() string { return BytesToGBK(s[:]) }

// base64交易终端系统信息类型
type TThostFtdcBase64ClientSystemInfoType [365]byte

func (s TThostFtdcBase64ClientSystemInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBase64ClientSystemInfoType) GBString() string { return BytesToGBK(s[:]) }

// base64系统外部信息类型
type TThostFtdcBase64AdditionalInfoType [349]byte

func (s TThostFtdcBase64AdditionalInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcBase64AdditionalInfoType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCaptchaInfoType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCaptchaInfoType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcHandshakeDataType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcHandshakeDataType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcCryptoKeyVersionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCryptoKeyVersionType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcSoftwareProviderIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSoftwareProviderIDType) GBString() string { return BytesToGBK(s[:]) }

// 信息采集时间类型
type TThostFtdcCollectTimeType [21]byte

func (s TThostFtdcCollectTimeType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcCollectTimeType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcOTCTraderIDType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcOTCTraderIDType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcIDBNameType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcIDBNameType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcSyncDescriptionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSyncDescriptionType) GBString() string { return BytesToGBK(s[:]) }
...
func (s TThostFtdcSysVersionType) String() string   { return BytesToString(s[:]) }
func (s TThostFtdcSysVersionType) GBString() string { return BytesToGBK(s[:]) }
